 ...
 *
 * Persistent, immutable HAMT with GC-managed nodes.
 *
...
#ifndef HAMT_GC_ALLOC
#error "HAMT_GC_ALLOC must be defined before including hamt.h"
#endif

/* --- Nodes allocated via GC; no reference counting --- */
