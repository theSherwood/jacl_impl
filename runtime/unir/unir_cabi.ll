...
%"unir_substrate::Grant<'_>" = type { { ptr, i64 }, i32, [1 x i32] }
%"core::option::Option<i64>" = type { i64, [1 x i64] }
...
@alloc_ed2c01013b845a2275ba463d39b0766f.92 = private unnamed_addr constant [11 x i8] c"<redacted>\00", align 1
@alloc_11e2992a5b9c8f277d4a00890b54e14e.91 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc_ed2c01013b845a2275ba463d39b0766f.92, [16 x i8] c"\0A\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }>, align 8
@alloc_cc193f9e0c79ce36721b88a4026725d4.113 = private unnamed_addr constant [10 x i8] c"\00\01\02\03\04\05\06\07\08\09", align 1
...
start:
  ...
  %_0.i = tail call noundef zeroext i1 @_RNvMsa_NtCscliFh4jUES5_4core3fmtNtB5_9Formatter3pad(ptr noalias noundef nonnull readonly align 8 dereferenceable(24) %f, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %_3.0, i64 noundef %_3.1) #23
  ret i1 %_0.i
}
...
bb9.i:                                            ; preds = %bb17
  %9 = tail call noundef i64 @_RNvNtNtCscliFh4jUES5_4core3str5count14do_count_chars(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %0, i64 noundef %1) #23
  br label %bb7
...
bb9.i:                                            ; preds = %bb7
  %5 = tail call noundef i64 @_RNvNtNtCscliFh4jUES5_4core3str5count14do_count_chars(ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %prefix.0, i64 noundef %prefix.1) #23
...
start:
  ...
  %_0.i = tail call noundef ptr @unir_host_alloc(i64 noundef %size, i64 noundef range(i64 1, -9223372036854775807) %align) #23
  ret ptr %_0.i
}
...
start:
  ...
  %1 = icmp sgt i64 %0, -1
  tail call void @llvm.assume(i1 %1)
  tail call void @unir_host_free(ptr noundef %ptr, i64 noundef %size, i64 noundef range(i64 1, -9223372036854775807) %align) #23
  ret void
}
...
start:
  ...
  %1 = icmp sgt i64 %0, -1
  tail call void @llvm.assume(i1 %1)
  %_0.i.i = tail call noundef ptr @unir_host_alloc(i64 noundef %new_size, i64 noundef range(i64 1, -9223372036854775807) %align) #23
...
define internal void @_RNvMs3_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecNtCsc1i3HueRnCr_14unir_substrate5GrantE8grow_oneCsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef align 8 captures(none) dereferenceable(16) %self) unnamed_addr #19 {
start:
  %_5 = load i64, ptr %self, align 8, !range !98, !noundef !4
  %0 = tail call fastcc { i64, i64 } @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner14grow_amortizedCsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef align 8 dereferenceable(16) %self, i64 noundef %_5) #23
...
define internal fastcc { i64, i64 } @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner14grow_amortizedCsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull align 8 captures(none) dereferenceable(16) %self, i64 noundef range(i64 0, -9223372036854775808) %len) unnamed_addr #20 {
start:
  %_16 = alloca [24 x i8], align 8
  %_22.0 = add nuw i64 %len, 1
  %_13 = load i64, ptr %self, align 8, !range !98, !noundef !4
  %0 = shl nuw i64 %_13, 1
  ...
  call fastcc void @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner11finish_growCsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_16, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef %cap1.sroa.0.1) #23
  %_35 = load i64, ptr %_16, align 8, !range !99, !noundef !4
...
bb22:                                             ; preds = %start
  %_37.0 = load i64, ptr %2, align 8, !range !100, !noundef !4
...
; Function Attrs: cold nounwind nonlazybind uwtable
define internal fastcc void @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner11finish_growCsdMVUwQQj4R6_9unir_cabi(ptr dead_on_unwind noalias noundef nonnull writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) initializes((0, 8)) %_0, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(16) %self, i64 noundef range(i64 4, -1) %cap) unnamed_addr #20 {
start:
  %_17.0.i = mul i64 %cap, 24
  %or.cond.i = icmp ugt i64 %cap, 384307168202282325
  br i1 %or.cond.i, label %bb8, label %bb11, !prof !101

bb11:                                             ; preds = %start
  %_30 = load i64, ptr %self, align 8, !range !98, !noundef !4
  %0 = icmp eq i64 %_30, 0
  br i1 %0, label %bb14, label %bb15

bb14:                                             ; preds = %bb11
  %1 = icmp eq i64 %_17.0.i, 0
  br i1 %1, label %bb6, label %bb4

bb15:                                             ; preds = %bb11
  %_31 = mul nuw i64 %_30, 24
  %2 = getelementptr inbounds nuw i8, ptr %self, i64 8
  %_40 = load ptr, ptr %2, align 8, !nonnull !4, !noundef !4
  %_12.i.i = icmp uge i64 %_17.0.i, %_31
  tail call void @llvm.assume(i1 %_12.i.i)
  %_0.i.i.i.i.i = tail call noundef ptr @unir_host_alloc(i64 noundef %_17.0.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  %3 = icmp eq ptr %_0.i.i.i.i.i, null
  br i1 %3, label %bb5, label %bb3.i.i.i.i

bb3.i.i.i.i:                                      ; preds = %bb15
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %_0.i.i.i.i.i, ptr noundef nonnull align 1 dereferenceable(1) %_40, i64 range(i64 24, 0) %_31, i1 false)
  tail call void @unir_host_free(ptr noundef nonnull %_40, i64 noundef range(i64 24, 0) %_31, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  br label %bb6

bb4:                                              ; preds = %bb14
  tail call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %_0.i.i.i.i = tail call noalias noundef ptr @unir_host_alloc(i64 noundef %_17.0.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  %4 = icmp eq ptr %_0.i.i.i.i, null
...
bb6:                                              ; preds = %bb4, %bb3.i.i.i.i, %bb14
  %_0.sroa.0.0.i.i.pn12 = phi ptr [ %_0.i.i.i.i, %bb4 ], [ %_0.i.i.i.i.i, %bb3.i.i.i.i ], [ inttoptr (i64 8 to ptr), %bb14 ]
  %6 = getelementptr inbounds nuw i8, ptr %_0, i64 8
  store ptr %_0.sroa.0.0.i.i.pn12, ptr %6, align 8
  br label %bb8
...
bb8:                                              ; preds = %bb6, %bb5, %start
  ...
  %7 = getelementptr inbounds nuw i8, ptr %_0, i64 %.sink15
  store i64 %_17.0.i.sink, ptr %7, align 8
...
start:
  ...
  %_7.sroa.4.0._5.sroa_idx = getelementptr inbounds nuw i8, ptr %_5, i64 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %0, i8 0, i64 48, i1 false)
  store ptr inttoptr (i64 8 to ptr), ptr %_7.sroa.4.0._5.sroa_idx, align 8
  %_7.sroa.5.0._5.sroa_idx = getelementptr inbounds nuw i8, ptr %_5, i64 16
  store i64 0, ptr %_7.sroa.5.0._5.sroa_idx, align 8
  tail call void @llvm.experimental.noalias.scope.decl(metadata !102)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %err.i)
  %1 = getelementptr inbounds nuw i8, ptr %c, i64 52
  %2 = load i8, ptr %1, align 4, !range !105, !alias.scope !102, !noalias !106, !noundef !4
  %.not.i = icmp eq i8 %2, 4
  br i1 %.not.i, label %bb8.i, label %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2

_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2: ; preds = %start
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %err.i)
  br label %bb3

bb8.i:                                            ; preds = %start
  %_8 = getelementptr inbounds nuw i8, ptr %c, i64 16
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %err.i, ptr noalias noundef nonnull align 8 dereferenceable(40) %_8, ptr noalias noundef nonnull align 8 dereferenceable(72) %_5, i8 noundef 11, i8 noundef 3, i8 undef) #23, !noalias !109
  %3 = load i8, ptr %err.i, align 8, !range !105, !noalias !110, !noundef !4
  %4 = icmp eq i8 %3, 0
  br i1 %4, label %bb4.i, label %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit

bb4.i:                                            ; preds = %bb8.i
  %5 = getelementptr inbounds nuw i8, ptr %err.i, i64 1
  %6 = load i8, ptr %5, align 1, !range !111, !noalias !110, !noundef !4
  %_21.i8 = icmp ne i8 %6, 3
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %err.i)
  %. = sext i1 %_21.i8 to i64
  br label %bb3
...
bb3:                                              ; preds = %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, %bb4.i, %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2
  %_0.sroa.0.0 = phi i64 [ -1, %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2 ], [ %., %bb4.i ], [ %switch.offset, %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit ]
  call void @llvm.experimental.noalias.scope.decl(metadata !112)
  call void @llvm.experimental.noalias.scope.decl(metadata !115)
  call void @llvm.experimental.noalias.scope.decl(metadata !118)
  call void @llvm.experimental.noalias.scope.decl(metadata !121)
  call void @llvm.experimental.noalias.scope.decl(metadata !124)
  %_9.i.i.i.i.i = load i64, ptr %_5, align 8, !range !98, !alias.scope !127, !noundef !4
  %7 = icmp eq i64 %_9.i.i.i.i.i, 0
  br i1 %7, label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, label %bb6.i.i.i.i.i

bb6.i.i.i.i.i:                                    ; preds = %bb3
  %_10.i.i.i.i.i = shl nuw i64 %_9.i.i.i.i.i, 4
  %_19.i.i.i.i.i = load ptr, ptr %_7.sroa.4.0._5.sroa_idx, align 8, !alias.scope !127, !nonnull !4, !noundef !4
  call void @unir_host_free(ptr noundef nonnull %_19.i.i.i.i.i, i64 noundef range(i64 16, 0) %_10.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !127
  br label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit

_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %bb6.i.i.i.i.i, %bb3
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %_5)
  ret i64 %_0.sroa.0.0
}

; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr dead_on_unwind noalias noundef nonnull writable writeonly sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_0, ptr noalias noundef nonnull align 8 captures(address, read_provenance) dereferenceable(40) %self, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef range(i8 0, 12) %0, i8 noundef range(i8 0, 4) %1, i8 %2) unnamed_addr #1 {
start:
  %3 = getelementptr inbounds nuw i8, ptr %self, i64 38
  %4 = load i8, ptr %3, align 2, !range !128, !noundef !4
...
bb17:                                             ; preds = %bb18, %bb19, %bb4
  ...
  %8 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef 8, i32 noundef %_10.sroa.0.0) #23
  br label %bb8
...
bb5:                                              ; preds = %bb2
  %9 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u64(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef 128, i64 noundef -1) #23
  br label %bb8
...
bb13:                                             ; preds = %bb14, %bb2
  ...
  %11 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef 144, i32 noundef %_11.sroa.0.0) #23
  br label %bb8

bb10:                                             ; preds = %bb8
  %..i = select i1 %_7, i64 384, i64 256
  %.13.i = select i1 %_7, i64 260, i64 388
  %12 = tail call i64 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %self, i64 noundef %.13.i) #23, !noalias !129
...
bb17.i:                                           ; preds = %bb10
  ...
  %_11.i = load i32, ptr %15, align 8, !alias.scope !132, !noalias !129
...
bb7.i:                                            ; preds = %bb17.i
  store i32 %.sroa.6.0.extract.trunc.i, ptr %15, align 8, !alias.scope !132, !noalias !129
  %16 = getelementptr inbounds nuw i8, ptr %self, i64 24
  %_13.i = load i32, ptr %16, align 8, !alias.scope !132, !noalias !129, !noundef !4
  %_12.i = add i32 %_13.i, 1
  store i32 %_12.i, ptr %16, align 8, !alias.scope !132, !noalias !129
  %17 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %self, i64 noundef %..i, i32 noundef %_12.i) #23, !noalias !129
  %.not.i = icmp eq i8 %17, 7
  br i1 %.not.i, label %bb19.i, label %bb12

bb19.i:                                           ; preds = %bb7.i
  %18 = tail call i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate6notify(ptr noalias noundef nonnull align 8 dereferenceable(72) %s, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %self, i64 noundef %..i, i32 noundef 1) #23
  br label %bb12
...
define noundef range(i32 0, 1024) i32 @unir_consumer_ended(ptr noundef readonly captures(none) %c) unnamed_addr #21 {
start:
  %0 = getelementptr inbounds nuw i8, ptr %c, i64 52
  %1 = load i8, ptr %0, align 4, !range !105, !noundef !4
...
start:
  ...
  tail call void @unir_host_free(ptr noundef nonnull %c, i64 noundef 112, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !134
  ret void
}
...
bb9.i:                                            ; preds = %start
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_9.i), !noalias !139
  %or.cond.i = icmp ugt i64 %0, 4294967295
  br i1 %or.cond.i, label %bb11.i, label %bb12.i

bb11.i:                                           ; preds = %bb9.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_9.i), !noalias !139
  br label %bb2
...
bb12.i:                                           ; preds = %bb9.i
  ...
  call void @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate10region_map(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_9.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %vat, i32 noundef %_26.i) #23, !noalias !139
  %7 = load i8, ptr %_9.i, align 8, !range !128, !noalias !139, !noundef !4
...
bb14.i:                                           ; preds = %bb12.i
  ...
  %_30.0.i = load i64, ptr %9, align 8, !noalias !139, !noundef !4
  %10 = getelementptr inbounds nuw i8, ptr %_9.i, i64 16
  %_30.1.i = load i64, ptr %10, align 8, !noalias !139, !noundef !4
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_9.i), !noalias !139
...
bb3.i.i:                                          ; preds = %bb14.i
  call void @llvm.lifetime.start.p0(i64 112, ptr nonnull %c.i.i), !noalias !143
  ...
  store i64 %_30.0.i, ptr %12, align 8, !noalias !143
  %_10.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 24
  store i64 %_30.1.i, ptr %_10.sroa.4.0..sroa_idx.i.i, align 8, !noalias !143
  %_10.sroa.5.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 32
  store i32 %1, ptr %_10.sroa.5.0..sroa_idx.i.i, align 8, !noalias !143
  %_10.sroa.6.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 36
  store i32 %2, ptr %_10.sroa.6.0..sroa_idx.i.i, align 4, !noalias !143
  %_10.sroa.7.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 40
  store i32 0, ptr %_10.sroa.7.0..sroa_idx.i.i, align 8, !noalias !143
  %_10.sroa.8.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 44
  store i32 0, ptr %_10.sroa.8.0..sroa_idx.i.i, align 4, !noalias !143
  %_10.sroa.9.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 48
  store i32 0, ptr %_10.sroa.9.0..sroa_idx.i.i, align 8, !noalias !143
  %_10.sroa.10.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 52
  store i8 4, ptr %_10.sroa.10.0..sroa_idx.i.i, align 4, !noalias !143
  %_10.sroa.12.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 54
  store i8 1, ptr %_10.sroa.12.0..sroa_idx.i.i, align 2, !noalias !143
  %13 = getelementptr inbounds nuw i8, ptr %c.i.i, i64 56
  %14 = getelementptr inbounds nuw i8, ptr %c.i.i, i64 72
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %13, i8 0, i64 16, i1 false), !noalias !143
  store i64 %spec.store.select.i.i, ptr %14, align 8, !noalias !143
  %15 = getelementptr inbounds nuw i8, ptr %c.i.i, i64 80
  store i64 512, ptr %15, align 8, !noalias !143
  %16 = getelementptr inbounds nuw i8, ptr %c.i.i, i64 88
  store i64 0, ptr %c.i.i, align 8, !noalias !143
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(17) %16, i8 0, i64 17, i1 false), !noalias !143
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_15.i.i), !noalias !143
  call fastcc void @_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE5grantNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_15.i.i, ptr noalias noundef align 8 dereferenceable(112) %c.i.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %vat) #23, !noalias !147
  %17 = load i8, ptr %_15.i.i, align 8, !range !148, !noalias !143, !noundef !4
  %.not.i.i = icmp eq i8 %17, 5
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_15.i.i), !noalias !143
...
bb11.i.i:                                         ; preds = %bb3.i.i
  call void @llvm.lifetime.end.p0(i64 112, ptr nonnull %c.i.i), !noalias !143
...
_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4openNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i: ; preds = %bb3.i.i
  %_16.sroa.0.0.copyload1.i = load i64, ptr %c.i.i, align 8, !noalias !149
  %_16.sroa.7.0.c.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 8
  %_16.sroa.7.0.copyload2.i = load i8, ptr %_16.sroa.7.0.c.i.sroa_idx.i, align 8, !noalias !149
  %_16.sroa.9.0.c.i.sroa_idx.i = getelementptr inbounds nuw i8, ptr %c.i.i, i64 9
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(103) %_16.sroa.9.i, ptr noundef nonnull align 1 dereferenceable(103) %_16.sroa.9.0.c.i.sroa_idx.i, i64 103, i1 false), !noalias !149
  call void @llvm.lifetime.end.p0(i64 112, ptr nonnull %c.i.i), !noalias !143
...
bb5:                                              ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4openNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i
  ...
  call void @llvm.lifetime.end.p0(i64 103, ptr nonnull %_16.sroa.9.i)
  call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %_0.i.i.i = call noalias noundef ptr @unir_host_alloc(i64 noundef 112, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  %19 = icmp eq ptr %_0.i.i.i, null
  br i1 %19, label %bb6, label %bb7, !prof !150
...
; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE5grantNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr dead_on_unwind noalias noundef nonnull writable writeonly sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_0, ptr noalias noundef nonnull align 8 captures(address, read_provenance) dereferenceable(112) %self, ptr noalias noundef nonnull align 8 dereferenceable(72) %s) unnamed_addr #1 {
start:
  ...
  %_3 = add i64 %_4, %_5
  %3 = load i64, ptr %self, align 8, !range !99, !noundef !4
...
bb2:                                              ; preds = %start
  ...
  %9 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u64(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %1, i64 noundef 136, i64 noundef %spec.store.select) #23
  %.not = icmp eq i8 %9, 7
  %10 = getelementptr inbounds nuw i8, ptr %self, i64 54
  %11 = load i8, ptr %10, align 2, !range !128
...
bb17:                                             ; preds = %bb2
  ...
  %13 = tail call i64 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %1, i64 noundef %.13.i) #23, !noalias !151
...
bb17.i:                                           ; preds = %bb17
  ...
  %_11.i = load i32, ptr %16, align 8, !alias.scope !154, !noalias !151
  %_10.i = icmp ne i32 %_11.i, %.sroa.6.0.extract.trunc.i
  %or.cond.i = select i1 %15, i1 %_10.i, i1 false
  br i1 %or.cond.i, label %bb7.i, label %bb6

bb7.i:                                            ; preds = %bb17.i
  store i32 %.sroa.6.0.extract.trunc.i, ptr %16, align 8, !alias.scope !154, !noalias !151
  %17 = getelementptr inbounds nuw i8, ptr %self, i64 40
  %_13.i = load i32, ptr %17, align 8, !alias.scope !154, !noalias !151, !noundef !4
  %_12.i = add i32 %_13.i, 1
  store i32 %_12.i, ptr %17, align 8, !alias.scope !154, !noalias !151
  %18 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %1, i64 noundef %..i, i32 noundef %_12.i) #23, !noalias !151
  %.not.i = icmp eq i8 %18, 7
  br i1 %.not.i, label %bb19.i, label %bb5

bb19.i:                                           ; preds = %bb7.i
  %19 = tail call i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate6notify(ptr noalias noundef nonnull align 8 dereferenceable(72) %s, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %1, i64 noundef %..i, i32 noundef 1) #23
...
bb5:                                              ; preds = %bb15, %bb7.i, %bb2
  ...
  tail call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_0, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef align 8 dereferenceable(72) %s, i8 noundef %switch.select10, i8 noundef %11, i8 %switch.select10) #23
  br label %bb8
...
start:
  ...
  call void @llvm.lifetime.start.p0(i64 72, ptr nonnull %_10)
  %1 = getelementptr inbounds nuw i8, ptr %_10, i64 24
  store i64 0, ptr %_10, align 8
  %_17.sroa.4.0._10.sroa_idx = getelementptr inbounds nuw i8, ptr %_10, i64 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %1, i8 0, i64 48, i1 false)
  store ptr inttoptr (i64 8 to ptr), ptr %_17.sroa.4.0._10.sroa_idx, align 8
  %_17.sroa.5.0._10.sroa_idx = getelementptr inbounds nuw i8, ptr %_10, i64 16
  store i64 0, ptr %_17.sroa.5.0._10.sroa_idx, align 8
  %_18 = icmp sgt i64 %timeout_ns, -1
  %_11.sroa.0.0 = zext i1 %_18 to i64
  tail call void @llvm.experimental.noalias.scope.decl(metadata !156)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !159)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %attempt.i)
  store ptr %.buf, ptr %attempt.i, align 8, !noalias !161
  %2 = getelementptr inbounds nuw i8, ptr %attempt.i, i64 8
  store i64 %cap, ptr %2, align 8, !noalias !161
  ...
  %3 = getelementptr inbounds nuw i8, ptr %c, i64 54
  %4 = getelementptr inbounds nuw i8, ptr %c, i64 44
...
bb27.i:                                           ; preds = %bb5.i
  %5 = load i8, ptr %3, align 2, !range !128, !alias.scope !164, !noalias !167, !noundef !4
  %_8.i.i = load i32, ptr %4, align 4, !alias.scope !164, !noalias !167, !noundef !4
...
bb5.i.i:                                          ; preds = %bb27.i
  ...
  store i32 %_9.i.i, ptr %4, align 4, !alias.scope !164, !noalias !167
...
_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i: ; preds = %bb5.i.i, %bb27.i
  ...
  %..i.i = select i1 %6, i64 388, i64 260
  %_0.i.i = call noundef range(i8 0, 8) i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %_0.i.i.i, i64 noundef %..i.i, i32 noundef %_12.i.i) #23, !noalias !156
...
bb26.i:                                           ; preds = %bb26.i.backedge, %start
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_7.i), !noalias !161
  call fastcc void @_RNCINvMs1_CsiYG6txRjdvL_9unir_edgeINtB8_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4readNtBN_8TemenVatEs_0CsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([24 x i8]) align 8 captures(address) dereferenceable(24) %_7.i, ptr noalias noundef align 8 dereferenceable(16) %attempt.i, ptr noalias noundef nonnull align 8 dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %_10) #30, !noalias !156
  %7 = load i64, ptr %_7.i, align 8, !range !168, !noalias !161, !noundef !4
  %8 = icmp eq i64 %7, 2
  %_46.sroa.0.0.copyload.i = load i64, ptr %_45.sroa.5.0._7.sroa_idx.i, align 8, !noalias !161
  %_46.sroa.5.0.copyload.i = load i16, ptr %_45.sroa.6.0._7.sroa_idx.i, align 8, !noalias !161
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_7.i), !noalias !161
...
bb32.i:                                           ; preds = %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i
  %..i = select i1 %6, i64 256, i64 384
  %10 = call i64 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %_0.i.i.i, i64 noundef %..i) #23, !noalias !156
  %.sroa.6.0.extract.shift.i = lshr i64 %10, 32
  %.sroa.6.0.extract.trunc.i = trunc nuw i64 %.sroa.6.0.extract.shift.i to i32
  %11 = trunc i64 %10 to i1
  br i1 %11, label %bb9.split.loop.exit52.i, label %bb10.i

bb9.split.loop.exit52.i:                          ; preds = %bb32.i
  %.sroa.4.0.extract.shift.le.i = lshr i64 %10, 8
...
bb9.i:                                            ; preds = %bb9.split.loop.exit52.i, %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i
  ...
  %12 = getelementptr inbounds nuw i8, ptr %_8, i64 8
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %12, ptr noalias noundef align 8 dereferenceable(40) %_0.i.i.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %_10, i8 noundef %switch.select27.i, i8 noundef %5, i8 %switch.select27.i) #23
  br label %bb2.sink.split

bb10.i:                                           ; preds = %bb32.i
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_24.i), !noalias !161
  call fastcc void @_RNCINvMs1_CsiYG6txRjdvL_9unir_edgeINtB8_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4readNtBN_8TemenVatEs_0CsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([24 x i8]) align 8 captures(address) dereferenceable(24) %_24.i, ptr noalias noundef align 8 dereferenceable(16) %attempt.i, ptr noalias noundef nonnull align 8 dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %_10) #30, !noalias !156
  %13 = load i64, ptr %_24.i, align 8, !range !168, !noalias !161, !noundef !4
  %14 = icmp eq i64 %13, 2
  %_61.sroa.0.0.copyload.i = load i64, ptr %_60.sroa.5.0._24.sroa_idx.i, align 8, !noalias !161
  %_61.sroa.5.0.copyload.i = load i16, ptr %_60.sroa.6.0._24.sroa_idx.i, align 8, !noalias !161
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_24.i), !noalias !161
  br i1 %14, label %bb42.i, label %bb43.i

bb42.i:                                           ; preds = %bb10.i
  %15 = getelementptr inbounds nuw i8, ptr %_8, i64 8
  store i64 %_61.sroa.0.0.copyload.i, ptr %15, align 8, !alias.scope !156, !noalias !169
  %_63.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_8, i64 16
  store i16 %_61.sroa.5.0.copyload.i, ptr %_63.sroa.2.0..sroa_idx.i, align 8, !alias.scope !156, !noalias !169
  br label %bb2.sink.split

bb43.i:                                           ; preds = %bb10.i
  %16 = trunc nuw i64 %13 to i1
  br i1 %16, label %bb13.i, label %bb12.i

bb13.i:                                           ; preds = %bb43.i
  %17 = call fastcc noundef i8 @_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef align 8 dereferenceable(40) %_0.i.i.i, i1 noundef zeroext false) #23, !noalias !156
  %.not25.i = icmp eq i8 %17, 7
  br i1 %.not25.i, label %bb17.i, label %bb16.i

bb12.i:                                           ; preds = %bb43.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_38.i), !noalias !161
  call void @llvm.experimental.noalias.scope.decl(metadata !170)
  call void @llvm.experimental.noalias.scope.decl(metadata !173)
  %18 = load i8, ptr %3, align 2, !range !128, !alias.scope !175, !noalias !176, !noundef !4
  %19 = trunc nuw i8 %18 to i1
  %..i34.i = select i1 %19, i64 256, i64 384
  %20 = call { i1, i8 } @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate4wait(ptr noalias noundef nonnull align 8 dereferenceable(72) %_10, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %_0.i.i.i, i64 noundef %..i34.i, i32 noundef %.sroa.6.0.extract.trunc.i, i64 noundef range(i64 0, 2) %_11.sroa.0.0, i64 %timeout_ns) #23, !noalias !178
...
bb13.i.i:                                         ; preds = %bb12.i
  %_8.i.i.i = load i32, ptr %4, align 4, !alias.scope !179, !noalias !176, !noundef !4
...
bb5.i.i.i:                                        ; preds = %bb13.i.i
  ...
  store i32 %_9.i.i.i, ptr %4, align 4, !alias.scope !179, !noalias !176
...
_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i.i: ; preds = %bb5.i.i.i, %bb13.i.i
  ...
  %_0.i.i35.i = call noundef range(i8 0, 8) i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %_0.i.i.i, i64 noundef %..i.i.i, i32 noundef %_12.i.i.i) #23, !noalias !178
...
_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread37.i: ; preds = %bb6.i.i
  store i8 1, ptr %_38.i, align 8, !alias.scope !170, !noalias !182
  br label %bb49.i
...
_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i: ; preds = %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i.i, %bb12.i
  %waited.sroa.4.0.i.i = phi i8 [ %_0.i.i35.i, %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i.i ], [ %22, %bb12.i ]
  ...
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_38.i, ptr noalias noundef nonnull align 8 dereferenceable(40) %_0.i.i.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %_10, i8 noundef %switch.select8.i.i, i8 noundef %18, i8 %switch.select8.i.i) #23, !noalias !156
  %.pr.i = load i8, ptr %_38.i, align 8, !noalias !161
  %.not24.i = icmp eq i8 %.pr.i, 5
  br i1 %.not24.i, label %bb50.i, label %bb49.i

bb16.i:                                           ; preds = %bb13.i
  %switch.selectcmp28.i = icmp eq i8 %17, 4
  %switch.select29.i = select i1 %switch.selectcmp28.i, i8 8, i8 2
  %switch.selectcmp30.i = icmp eq i8 %17, 3
  %switch.select31.i = select i1 %switch.selectcmp30.i, i8 6, i8 %switch.select29.i
  %23 = load i8, ptr %3, align 2, !range !128, !alias.scope !159, !noalias !167, !noundef !4
  %24 = getelementptr inbounds nuw i8, ptr %_8, i64 8
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %24, ptr noalias noundef align 8 dereferenceable(40) %_0.i.i.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %_10, i8 noundef %switch.select31.i, i8 noundef %23, i8 %switch.select31.i) #23
  br label %bb2.sink.split

bb17.i:                                           ; preds = %bb13.i
  %25 = getelementptr inbounds nuw i8, ptr %_8, i64 8
  store i64 %_61.sroa.0.0.copyload.i, ptr %25, align 8, !alias.scope !156, !noalias !169
  %26 = getelementptr inbounds nuw i8, ptr %_8, i64 16
  store i16 %_61.sroa.5.0.copyload.i, ptr %26, align 8, !alias.scope !156, !noalias !169
...
bb49.i:                                           ; preds = %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i, %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread37.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %27, ptr noundef nonnull align 8 dereferenceable(16) %_38.i, i64 16, i1 false), !noalias !169
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_38.i), !noalias !161
  br label %bb2.sink.split
...
bb5.i:                                            ; preds = %bb26.i
  ...
  call void @llvm.x86.sse2.pause(), !noalias !156
...
bb25.i:                                           ; preds = %bb26.i
  %28 = getelementptr inbounds nuw i8, ptr %_8, i64 8
  store i64 %_46.sroa.0.0.copyload.i, ptr %28, align 8, !alias.scope !156, !noalias !169
  %_48.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_8, i64 16
  store i16 %_46.sroa.5.0.copyload.i, ptr %_48.sroa.2.0..sroa_idx.i, align 8, !alias.scope !156, !noalias !169
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %attempt.i)
...
bb2:                                              ; preds = %bb2.sink.split, %bb25.i
  ...
  %e.sroa.0.0.copyload = load i8, ptr %29, align 8
...
bb3:                                              ; preds = %bb25.i, %bb17.i
  ...
  %f = load i64, ptr %30, align 8, !noundef !4
  %31 = icmp eq ptr %substream, null
  br i1 %31, label %bb7, label %bb5

bb5:                                              ; preds = %bb3
  %32 = getelementptr inbounds nuw i8, ptr %_8, i64 16
  %f2 = load i16, ptr %32, align 8, !noundef !4
...
bb7:                                              ; preds = %bb5, %bb3, %bb2
  ...
  %_9.i.i.i.i.i = load i64, ptr %_10, align 8, !range !98, !alias.scope !198, !noundef !4
  %33 = icmp eq i64 %_9.i.i.i.i.i, 0
  br i1 %33, label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, label %bb6.i.i.i.i.i

bb6.i.i.i.i.i:                                    ; preds = %bb7
  %_10.i.i.i.i.i = shl nuw i64 %_9.i.i.i.i.i, 4
  %_19.i.i.i.i.i = load ptr, ptr %_17.sroa.4.0._10.sroa_idx, align 8, !alias.scope !198, !nonnull !4, !noundef !4
  call void @unir_host_free(ptr noundef nonnull %_19.i.i.i.i.i, i64 noundef range(i64 16, 0) %_10.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !198
  br label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit
...
_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %bb6.i.i.i.i.i, %bb7
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %_10)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_8)
  ret i64 %_0.sroa.0.0
}

; Function Attrs: inlinehint nounwind nonlazybind uwtable
define internal fastcc void @_RNCINvMs1_CsiYG6txRjdvL_9unir_edgeINtB8_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4readNtBN_8TemenVatEs_0CsdMVUwQQj4R6_9unir_cabi(ptr dead_on_unwind noalias noundef nonnull writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_0, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(16) %_1, ptr noalias noundef nonnull align 8 captures(address, read_provenance) dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %s) unnamed_addr #22 {
start:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_7.i), !noalias !204
  tail call void @llvm.experimental.noalias.scope.decl(metadata !207)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !210)
  %1 = getelementptr inbounds nuw i8, ptr %c, i64 16
  %2 = getelementptr inbounds nuw i8, ptr %c, i64 52
  %3 = load i8, ptr %2, align 4, !range !105, !alias.scope !212, !noalias !213, !noundef !4
...
bb27.i.i:                                         ; preds = %start
  ...
  %_46.1.i.i = load i8, ptr %4, align 1, !alias.scope !212, !noalias !213
  %5 = getelementptr inbounds nuw i8, ptr %_7.i, i64 8
  store i8 0, ptr %5, align 8, !alias.scope !207, !noalias !215
  %_50.sroa.2.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %_7.i, i64 9
  store i8 %3, ptr %_50.sroa.2.0..sroa_idx.i.i, align 1, !alias.scope !207, !noalias !215
  %_50.sroa.3.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %_7.i, i64 10
  store i8 %_46.1.i.i, ptr %_50.sroa.3.0..sroa_idx.i.i, align 2, !alias.scope !207, !noalias !215
  br label %bb11.i

bb26.i.i:                                         ; preds = %start
  %6 = getelementptr inbounds nuw i8, ptr %c, i64 56
  %_7.i.i = load i64, ptr %6, align 8, !alias.scope !212, !noalias !213, !noundef !4
  %7 = getelementptr inbounds nuw i8, ptr %c, i64 96
  %_8.i.i = load i64, ptr %7, align 8, !alias.scope !212, !noalias !213, !noundef !4
  %_6.i.i = icmp eq i64 %_7.i.i, %_8.i.i
  br i1 %_6.i.i, label %bb2.i.i, label %bb11.i.i

bb2.i.i:                                          ; preds = %bb26.i.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_10.i.i), !noalias !216
  tail call void @llvm.experimental.noalias.scope.decl(metadata !217)
  %8 = tail call i64 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %1, i64 noundef 8) #23, !noalias !220
...
bb7.i.i.i.i:                                      ; preds = %bb2.i.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_8.i.i.i.i), !noalias !226
  call void @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u64(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_8.i.i.i.i, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %1, i64 noundef 0) #23, !noalias !220
  %10 = load i8, ptr %_8.i.i.i.i, align 8, !range !128, !noalias !226, !noundef !4
...
bb8.i.i.i.i:                                      ; preds = %bb7.i.i.i.i
  ...
  %_20.i.i.i.i = load i8, ptr %12, align 1, !range !227, !noalias !226, !noundef !4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_8.i.i.i.i), !noalias !226
  br label %bb3.i.i.i
...
bb3.i.i.i:                                        ; preds = %bb8.i.i.i.i, %bb6.i.i.i.i
  ...
  %14 = load i8, ptr %13, align 2, !range !128, !alias.scope !228, !noalias !229, !noundef !4
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_10.i.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %switch.select9.i.i.i, i8 noundef %14, i8 %switch.select9.i.i.i) #23, !noalias !230
...
bb4.i.i.i:                                        ; preds = %bb7.i.i.i.i
  ...
  %_19.i.i.i.i = load i64, ptr %15, align 8, !noalias !226, !noundef !4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_8.i.i.i.i), !noalias !226
...
bb14.i.i.i.i:                                     ; preds = %bb4.i.i.i.i
  ...
  %_14.i.i.i.i = load i8, ptr %19, align 1, !range !231, !noalias !232, !noundef !4
  br label %bb7.i.i.i

bb6.i.i.i:                                        ; preds = %bb4.i.i.i.i, %bb5.i.i.i.i, %bb6.i11.i.i.i, %bb2.i.i.i.i, %bb4.i.i.i
  %20 = getelementptr inbounds nuw i8, ptr %c, i64 54
  %21 = load i8, ptr %20, align 2, !range !128, !alias.scope !228, !noalias !229, !noundef !4
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_10.i.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef 3, i8 noundef %21, i8 3) #23, !noalias !230
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i
...
bb21.i.i.i:                                       ; preds = %bb7.i.i.i
  ...
  %_38.i.i.i = load i64, ptr %_20.i.i.i, align 8, !alias.scope !228, !noalias !229, !noundef !4
...
bb26.i.i.i:                                       ; preds = %bb24.i.i.i
  ...
  %_43.i.i.i = load i32, ptr %_22.i.i.i, align 8, !alias.scope !228, !noalias !229, !noundef !4
...
bb34.i.i.i:                                       ; preds = %bb26.i.i.i, %bb24.i.i.i
  store i64 %_19.i.i.i.i, ptr %7, align 8, !alias.scope !228, !noalias !229
...
bb33.i.i.i:                                       ; preds = %bb26.i.i.i, %bb21.i.i.i, %bb7.i.i.i
  ...
  %25 = load i8, ptr %24, align 2, !range !128, !alias.scope !228, !noalias !229, !noundef !4
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_10.i.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %checked.sroa.0.0.i.i.i, i8 noundef %25, i8 %checked.sroa.0.0.i.i.i) #23, !noalias !230
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i
...
bb9.i.i.i:                                        ; preds = %bb34.i.i.i
  ...
  store i8 1, ptr %26, align 8, !alias.scope !228, !noalias !229
  br label %bb29.i.i

bb10.i.i.i:                                       ; preds = %bb34.i.i.i
  %27 = icmp samesign ult i8 %_0.sroa.8.0.i.i.i.i, 10
  tail call void @llvm.assume(i1 %27)
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_10.i.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %_0.sroa.8.0.i.i.i.i, i8 noundef 0, i8 %_0.sroa.8.0.i.i.i.i) #23, !noalias !230
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i
...
_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i: ; preds = %bb10.i.i.i, %bb33.i.i.i, %bb6.i.i.i, %bb3.i.i.i
  %.pr.i.i = load i8, ptr %_10.i.i, align 8, !noalias !216
...
bb28.i.i:                                         ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %31, ptr noundef nonnull align 8 dereferenceable(16) %_10.i.i, i64 16, i1 false), !noalias !215
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_10.i.i), !noalias !216
  br label %bb11.i
...
bb5.i.i:                                          ; preds = %bb29.i.i
  ...
  %33 = load i8, ptr %32, align 8, !range !128, !alias.scope !212, !noalias !213, !noundef !4
...
bb13.i.i:                                         ; preds = %bb11.i.i
  ...
  %35 = load i8, ptr %34, align 2, !range !128, !alias.scope !212, !noalias !213, !noundef !4
  %36 = getelementptr inbounds nuw i8, ptr %_7.i, i64 8
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %36, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %switch.select15.i.i, i8 noundef %35, i8 %switch.select15.i.i) #23, !noalias !233
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %h.i.i), !noalias !216
  br label %bb11.i

bb14.i.i:                                         ; preds = %bb11.i.i
  %_31.sroa.0.0.copyload.i.i = load i64, ptr %h.i.i, align 8, !noalias !216
...
_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4peekNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread40.i: ; preds = %bb18.i.i, %bb5.i.i.i, %bb14.i.i
  ...
  %42 = load i8, ptr %41, align 2, !range !128, !alias.scope !212, !noalias !213, !noundef !4
  %43 = getelementptr inbounds nuw i8, ptr %_7.i, i64 8
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %43, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef 3, i8 noundef %42, i8 3) #23, !noalias !233
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %h.i.i), !noalias !216
  br label %bb11.i
...
bb18.i.i:                                         ; preds = %bb5.i.i.i
  ...
  %_67.i.i = load i32, ptr %44, align 4, !alias.scope !212, !noalias !213, !noundef !4
...
bb9.i.i:                                          ; preds = %bb5.i.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_19.i.i), !noalias !216
  %45 = getelementptr inbounds nuw i8, ptr %c, i64 64
  %_5.i.i.i = load i64, ptr %45, align 8, !alias.scope !234, !noalias !237, !noundef !4
  %_3.i.i.i = icmp eq i64 %_14.i.i, %_5.i.i.i
  br i1 %_3.i.i.i, label %bb3.i, label %bb2.i22.i.i

bb2.i22.i.i:                                      ; preds = %bb9.i.i
  %46 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u64(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %1, i64 noundef 128, i64 noundef %_14.i.i) #23, !noalias !240
...
bb4.i23.i.i:                                      ; preds = %bb2.i22.i.i
  ...
  %48 = load i8, ptr %47, align 2, !range !128, !alias.scope !234, !noalias !237, !noundef !4
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_19.i.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %switch.select4.i.i.i, i8 noundef %48, i8 %switch.select4.i.i.i) #23, !noalias !230
...
bb5.i27.i.i:                                      ; preds = %bb2.i22.i.i
  store i64 %_14.i.i, ptr %45, align 8, !alias.scope !234, !noalias !237
  call fastcc void @_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE5grantNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_19.i.i, ptr noalias noundef nonnull align 8 dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %s) #23, !noalias !230
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i
...
_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i: ; preds = %bb5.i27.i.i, %bb4.i23.i.i
  %.pr36.i.i = load i8, ptr %_19.i.i, align 8, !noalias !216
  %.not.i.i = icmp eq i8 %.pr36.i.i, 5
  br i1 %.not.i.i, label %bb3.i, label %bb30.i.i

bb7.i.i:                                          ; preds = %bb5.i.i
  %49 = getelementptr inbounds nuw i8, ptr %_7.i, i64 8
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %49, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef 11, i8 noundef 2, i8 undef) #23, !noalias !233
  br label %bb11.i
...
bb30.i.i:                                         ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %50, ptr noundef nonnull align 8 dereferenceable(16) %_19.i.i, i64 16, i1 false), !noalias !215
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_19.i.i), !noalias !216
  br label %bb11.i
...
bb11.i:                                           ; preds = %bb30.i.i, %bb7.i.i, %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4peekNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread40.i, %bb13.i.i, %bb28.i.i, %bb27.i.i
  ...
  %_29.sroa.0.0.copyload.i = load i64, ptr %51, align 8, !noalias !204
  %_29.sroa.5.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_7.i, i64 16
  %_29.sroa.5.0.copyload.i = load i32, ptr %_29.sroa.5.0..sroa_idx.i, align 8, !noalias !204
  %_29.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_7.i, i64 20
  %_29.sroa.6.0.copyload.i = load i16, ptr %_29.sroa.6.0..sroa_idx.i, align 4, !noalias !204
  %_29.sroa.7.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_7.i, i64 22
  %_29.sroa.7.0.copyload.i = load i16, ptr %_29.sroa.7.0..sroa_idx.i, align 2, !noalias !204
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_7.i), !noalias !204
  %52 = getelementptr inbounds nuw i8, ptr %_0, i64 8
  store i64 %_29.sroa.0.0.copyload.i, ptr %52, align 8, !alias.scope !199, !noalias !241
  %_31.sroa.2.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_0, i64 16
  store i32 %_29.sroa.5.0.copyload.i, ptr %_31.sroa.2.0..sroa_idx.i, align 8, !alias.scope !199, !noalias !241
  %_31.sroa.3.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_0, i64 20
  store i16 %_29.sroa.6.0.copyload.i, ptr %_31.sroa.3.0..sroa_idx.i, align 4, !alias.scope !199, !noalias !241
  %_31.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %_0, i64 22
  store i16 %_29.sroa.7.0.copyload.i, ptr %_31.sroa.4.0..sroa_idx.i, align 2, !alias.scope !199, !noalias !241
  store i64 2, ptr %_0, align 8, !alias.scope !199, !noalias !241
...
bb6.i:                                            ; preds = %bb13.i
  ...
  %58 = load i8, ptr %57, align 2, !range !128, !alias.scope !202, !noalias !242, !noundef !4
  %59 = getelementptr inbounds nuw i8, ptr %_0, i64 8
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %59, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %switch.select18.i, i8 noundef %58, i8 %switch.select18.i) #23
  store i64 2, ptr %_0, align 8, !alias.scope !199, !noalias !241
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit

bb7.i:                                            ; preds = %bb13.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_23.i), !noalias !204
  call void @llvm.experimental.noalias.scope.decl(metadata !243)
  %60 = add i64 %28, 1
  store i64 %60, ptr %6, align 8, !alias.scope !246, !noalias !247
  %61 = getelementptr inbounds nuw i8, ptr %c, i64 32
  %62 = add i64 %off.i.i, %_66.i.i
  %_28.i.i = load i32, ptr %61, align 8, !alias.scope !246, !noalias !247, !noundef !4
  ...
  store i64 %spec.store.select.i.i, ptr %29, align 8, !alias.scope !246, !noalias !247
  %63 = call i64 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %1, i64 noundef 260) #23, !noalias !250
...
bb3.i.i:                                          ; preds = %bb7.i
  ...
  %66 = load i8, ptr %65, align 2, !range !128, !alias.scope !246, !noalias !247, !noundef !4
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_23.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %switch.select6.i.i, i8 noundef %66, i8 %switch.select6.i.i) #23, !noalias !199
...
bb4.i.i:                                          ; preds = %bb7.i
  ...
  %_17.i.i = load i64, ptr %68, align 8, !alias.scope !246, !noalias !247, !noundef !4
  %_15.i19.i = sub i64 %60, %_17.i.i
  %69 = getelementptr inbounds nuw i8, ptr %c, i64 72
  %_18.i.i = load i64, ptr %69, align 8, !alias.scope !246, !noalias !247, !noundef !4
...
bb7.i22.i:                                        ; preds = %bb4.i.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_20.i.i), !noalias !251
  %_3.i.i23.i = icmp eq i64 %60, %_17.i.i
  br i1 %_3.i.i23.i, label %bb20.i.i, label %bb2.i.i24.i

bb2.i.i24.i:                                      ; preds = %bb7.i22.i
  %70 = call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u64(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %1, i64 noundef 128, i64 noundef %60) #23, !noalias !252
...
bb4.i.i26.i:                                      ; preds = %bb2.i.i24.i
  ...
  %72 = load i8, ptr %71, align 2, !range !128, !alias.scope !256, !noalias !258, !noundef !4
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_20.i.i, ptr noalias noundef align 8 dereferenceable(40) %1, ptr noalias noundef nonnull align 8 dereferenceable(72) %s, i8 noundef %switch.select4.i.i30.i, i8 noundef %72, i8 %switch.select4.i.i30.i) #23, !noalias !259
...
bb5.i.i35.i:                                      ; preds = %bb2.i.i24.i
  store i64 %60, ptr %68, align 8, !alias.scope !256, !noalias !258
  call fastcc void @_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE5grantNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_20.i.i, ptr noalias noundef nonnull align 8 dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %s) #23, !noalias !259
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i31.i
...
_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i31.i: ; preds = %bb5.i.i35.i, %bb4.i.i26.i
  %.pr.i32.i = load i8, ptr %_20.i.i, align 8, !noalias !251
...
bb19.i34.i:                                       ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i31.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_23.i, ptr noundef nonnull align 8 dereferenceable(16) %_20.i.i, i64 16, i1 false), !noalias !260
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_20.i.i), !noalias !251
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i
...
_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i: ; preds = %bb19.i34.i, %bb3.i.i
  %.pr.i = load i8, ptr %_23.i, align 8, !noalias !204
...
bb23.i:                                           ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %73, ptr noundef nonnull align 8 dereferenceable(16) %_23.i, i64 16, i1 false), !noalias !241
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_23.i), !noalias !204
  store i64 2, ptr %_0, align 8, !alias.scope !199, !noalias !241
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit
...
bb24.i:                                           ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i, %bb20.i.i, %bb4.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_23.i), !noalias !204
  store i64 1, ptr %_0, align 8, !alias.scope !199, !noalias !241
  %_25.sroa.4.0._0.sroa_idx.i = getelementptr inbounds nuw i8, ptr %_0, i64 8
  store i64 %_39.i.i, ptr %_25.sroa.4.0._0.sroa_idx.i, align 8, !alias.scope !199, !noalias !241
  %_25.sroa.5.0._0.sroa_idx.i = getelementptr inbounds nuw i8, ptr %_0, i64 16
  store i16 %54, ptr %_25.sroa.5.0._0.sroa_idx.i, align 8, !alias.scope !199, !noalias !241
  br label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit
...
start:
  ...
  %1 = load i8, ptr %0, align 2, !range !128, !noundef !4
...
bb7:                                              ; preds = %bb5, %start
  ...
  %_0 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef %., i32 noundef %_12) #23
  ret i8 %_0
}
...
; Function Attrs: nounwind nonlazybind uwtable
define noundef range(i64 -5, 1) i64 @unir_consumer_resume(ptr noundef captures(address, read_provenance) %c) unnamed_addr #1 {
start:
  %_5 = alloca [72 x i8], align 8
  ...
  store i64 0, ptr %_7.sroa.5.0._5.sroa_idx, align 8
  %1 = getelementptr inbounds nuw i8, ptr %c, i64 52
  %2 = load i8, ptr %1, align 4, !range !105, !alias.scope !261, !noalias !264, !noundef !4
  %.not.i = icmp eq i8 %2, 4
  br i1 %.not.i, label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, label %bb3

_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %start
  store i64 0, ptr %c, align 8, !alias.scope !261, !noalias !264
  call fastcc void @_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE5grantNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_3, ptr noalias noundef nonnull align 8 dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %_5) #23
  %.pr = load i8, ptr %_3, align 8
  %3 = zext i8 %.pr to i64
  %switch.gep = getelementptr inbounds nuw [6 x i64], ptr @switch.table.unir_producer_write, i64 0, i64 %3
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %bb3

bb3:                                              ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, %start
  %_0.sroa.0.0 = phi i64 [ %switch.load, %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit ], [ -1, %start ]
  call void @llvm.experimental.noalias.scope.decl(metadata !267)
  call void @llvm.experimental.noalias.scope.decl(metadata !270)
  call void @llvm.experimental.noalias.scope.decl(metadata !273)
  call void @llvm.experimental.noalias.scope.decl(metadata !276)
  call void @llvm.experimental.noalias.scope.decl(metadata !279)
  %_9.i.i.i.i.i = load i64, ptr %_5, align 8, !range !98, !alias.scope !282, !noundef !4
  %4 = icmp eq i64 %_9.i.i.i.i.i, 0
...
bb6.i.i.i.i.i:                                    ; preds = %bb3
  %_10.i.i.i.i.i = shl nuw i64 %_9.i.i.i.i.i, 4
  %_19.i.i.i.i.i = load ptr, ptr %_7.sroa.4.0._5.sroa_idx, align 8, !alias.scope !282, !nonnull !4, !noundef !4
  call void @unir_host_free(ptr noundef nonnull %_19.i.i.i.i.i, i64 noundef range(i64 16, 0) %_10.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !282
  br label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit
...
bb3:                                              ; preds = %start
  ...
  call void @llvm.lifetime.start.p0(i64 72, ptr nonnull %_5.i), !noalias !283
  %1 = getelementptr inbounds nuw i8, ptr %_5.i, i64 24
  store i64 0, ptr %_5.i, align 8, !noalias !283
  %_8.sroa.4.0._5.sroa_idx.i = getelementptr inbounds nuw i8, ptr %_5.i, i64 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %1, i8 0, i64 48, i1 false), !noalias !283
  store ptr inttoptr (i64 8 to ptr), ptr %_8.sroa.4.0._5.sroa_idx.i, align 8, !noalias !283
  %_8.sroa.5.0._5.sroa_idx.i = getelementptr inbounds nuw i8, ptr %_5.i, i64 16
  store i64 0, ptr %_8.sroa.5.0._5.sroa_idx.i, align 8, !noalias !283
  tail call void @llvm.experimental.noalias.scope.decl(metadata !286)
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %err.i.i), !noalias !283
  %2 = getelementptr inbounds nuw i8, ptr %c, i64 52
  %3 = load i8, ptr %2, align 4, !range !105, !alias.scope !289, !noalias !290, !noundef !4
...
_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2.i: ; preds = %bb3
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %err.i.i), !noalias !283
  br label %bb3.i

bb8.i.i:                                          ; preds = %bb3
  %_9.i = getelementptr inbounds nuw i8, ptr %c, i64 16
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %err.i.i, ptr noalias noundef nonnull align 8 dereferenceable(40) %_9.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %_5.i, i8 noundef range(i8 0, 10) %_11, i8 noundef 1, i8 range(i8 0, 10) %_11) #23, !noalias !293
  %4 = load i8, ptr %err.i.i, align 8, !range !105, !noalias !294, !noundef !4
  %5 = icmp eq i8 %4, 0
...
bb4.i.i:                                          ; preds = %bb8.i.i
  ...
  %7 = load i8, ptr %6, align 1, !range !111, !noalias !294, !noundef !4
  %8 = getelementptr inbounds nuw i8, ptr %err.i.i, i64 2
  %_23.i.i = load i8, ptr %8, align 2, !range !231, !noalias !283
  %_22.i.i = icmp ne i8 %_23.i.i, %_11
  %_12.i.i = icmp ne i8 %7, 1
  %or.cond9.not.i = select i1 %_12.i.i, i1 true, i1 %_22.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %err.i.i), !noalias !283
...
bb3.i:                                            ; preds = %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i, %bb4.i.i, %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2.i
  ...
  %_9.i.i.i.i.i.i = load i64, ptr %_5.i, align 8, !range !98, !alias.scope !310, !noalias !283, !noundef !4
  %9 = icmp eq i64 %_9.i.i.i.i.i.i, 0
  br i1 %9, label %_RNCNvCsdMVUwQQj4R6_9unir_cabi19unir_consumer_sever0B3_.exit, label %bb6.i.i.i.i.i.i

bb6.i.i.i.i.i.i:                                  ; preds = %bb3.i
  %_10.i.i.i.i.i.i = shl nuw i64 %_9.i.i.i.i.i.i, 4
  %_19.i.i.i.i.i.i = load ptr, ptr %_8.sroa.4.0._5.sroa_idx.i, align 8, !alias.scope !310, !noalias !283, !nonnull !4, !noundef !4
  call void @unir_host_free(ptr noundef nonnull %_19.i.i.i.i.i.i, i64 noundef range(i64 16, 0) %_10.i.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !310
  br label %_RNCNvCsdMVUwQQj4R6_9unir_cabi19unir_consumer_sever0B3_.exit

_RNCNvCsdMVUwQQj4R6_9unir_cabi19unir_consumer_sever0B3_.exit: ; preds = %bb6.i.i.i.i.i.i, %bb3.i
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %_5.i), !noalias !283
  br label %bb5
...
; Function Attrs: nounwind nonlazybind uwtable
define noundef range(i64 -5, 1) i64 @unir_consumer_suspend(ptr noundef captures(address, read_provenance) %c) unnamed_addr #1 {
start:
  %_7 = alloca [72 x i8], align 8
  %_5 = alloca [16 x i8], align 8
  %0 = getelementptr inbounds nuw i8, ptr %c, i64 56
  %_4 = load i64, ptr %0, align 8, !noundef !4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %_5)
  call void @llvm.lifetime.start.p0(i64 72, ptr nonnull %_7)
  %1 = getelementptr inbounds nuw i8, ptr %_7, i64 24
  store i64 0, ptr %_7, align 8
  %_9.sroa.4.0._7.sroa_idx = getelementptr inbounds nuw i8, ptr %_7, i64 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %1, i8 0, i64 48, i1 false)
  store ptr inttoptr (i64 8 to ptr), ptr %_9.sroa.4.0._7.sroa_idx, align 8
  %_9.sroa.5.0._7.sroa_idx = getelementptr inbounds nuw i8, ptr %_7, i64 16
  store i64 0, ptr %_9.sroa.5.0._7.sroa_idx, align 8
  %2 = getelementptr inbounds nuw i8, ptr %c, i64 52
  %3 = load i8, ptr %2, align 4, !range !105, !alias.scope !311, !noalias !314, !noundef !4
  %.not.i = icmp eq i8 %3, 4
  br i1 %.not.i, label %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, label %bb3

_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %start
  store i64 1, ptr %c, align 8, !alias.scope !311, !noalias !314
  %4 = getelementptr inbounds nuw i8, ptr %c, i64 8
  store i64 %_4, ptr %4, align 8, !alias.scope !311, !noalias !314
  call fastcc void @_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE5grantNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_5, ptr noalias noundef nonnull align 8 dereferenceable(112) %c, ptr noalias noundef nonnull align 8 dereferenceable(72) %_7) #23
  %.pr = load i8, ptr %_5, align 8
  %5 = zext i8 %.pr to i64
  %switch.gep = getelementptr inbounds nuw [6 x i64], ptr @switch.table.unir_producer_write, i64 0, i64 %5
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %bb3
...
bb3:                                              ; preds = %_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, %start
  ...
  %_9.i.i.i.i.i = load i64, ptr %_7, align 8, !range !98, !alias.scope !332, !noundef !4
  %6 = icmp eq i64 %_9.i.i.i.i.i, 0
  br i1 %6, label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, label %bb6.i.i.i.i.i

bb6.i.i.i.i.i:                                    ; preds = %bb3
  %_10.i.i.i.i.i = shl nuw i64 %_9.i.i.i.i.i, 4
  %_19.i.i.i.i.i = load ptr, ptr %_9.sroa.4.0._7.sroa_idx, align 8, !alias.scope !332, !nonnull !4, !noundef !4
  call void @unir_host_free(ptr noundef nonnull %_19.i.i.i.i.i, i64 noundef range(i64 16, 0) %_10.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !332
  br label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit

_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %bb6.i.i.i.i.i, %bb3
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %_7)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %_5)
  ret i64 %_0.sroa.0.0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none) uwtable
define noundef range(i64 -5, -38654705143) i64 @unir_edge_len(i32 noundef %capacity, i32 noundef %slot_size) unnamed_addr #24 {
start:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none) uwtable
define noundef range(i64 -8, 4294967288) i64 @unir_edge_max_payload(i32 noundef %capacity, i32 noundef %slot_size) unnamed_addr #24 {
start:
  %.not.i.i = icmp ne i32 %capacity, 0
  %0 = icmp ugt i32 %slot_size, 8
  %or.cond.i.i = and i1 %.not.i.i, %0
...
; Function Attrs: nounwind nonlazybind uwtable
define noundef range(i64 -8, 4294967296) i64 @unir_endowed(ptr noundef captures(address, read_provenance) %vat, ptr noundef captures(address, read_provenance) %name, i64 noundef %name_len) unnamed_addr #1 {
start:
  %_3.i = alloca [24 x i8], align 8
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_3.i)
  %0 = icmp eq i64 %name_len, 0
  %.ptr.i = select i1 %0, ptr inttoptr (i64 1 to ptr), ptr %name
  call void @_RNvNtNtCscliFh4jUES5_4core3str8converts9from_utf8(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_3.i, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %.ptr.i, i64 noundef %name_len) #23
  %_7.i = load i64, ptr %_3.i, align 8, !range !99, !noundef !4
  %1 = trunc nuw i64 %_7.i to i1
  %2 = getelementptr inbounds nuw i8, ptr %_3.i, i64 8
  %_8.0.i = load ptr, ptr %2, align 8, !nonnull !4, !align !5
  %3 = getelementptr inbounds nuw i8, ptr %_3.i, i64 16
  %_8.1.i = load i64, ptr %3, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_3.i)
  br i1 %1, label %bb5, label %bb3

bb3:                                              ; preds = %start
  %4 = tail call { i32, i32 } @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate7endowed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(72) %vat, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %_8.0.i, i64 noundef %_8.1.i) #23
  %5 = extractvalue { i32, i32 } %4, 0
  %6 = trunc i32 %5 to i1
  %7 = extractvalue { i32, i32 } %4, 1
  %8 = zext i32 %7 to i64
  %_0.sroa.0.0 = select i1 %6, i64 %8, i64 -8
  br label %bb5

bb5:                                              ; preds = %bb3, %start
  %_0.sroa.0.1 = phi i64 [ %_0.sroa.0.0, %bb3 ], [ -7, %start ]
  ret i64 %_0.sroa.0.1
}
...
bb5:                                              ; preds = %start
  ...
  call void @_RNvMs0_CsIEB7taFyf8_10unir_temenNtB5_8TemenVat4join(ptr noalias noundef nonnull sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_6, ptr noalias noundef align 8 dereferenceable(72) %vat, i32 noundef %_9) #23
  %0 = load i8, ptr %_6, align 8, !range !128, !noundef !4
...
start:
  ...
  %2 = load i8, ptr %1, align 4, !range !105, !alias.scope !333, !noalias !336, !noundef !4
  %.not.i = icmp eq i8 %2, 4
  br i1 %.not.i, label %bb8.i, label %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2
...
bb8.i:                                            ; preds = %start
  %_8 = getelementptr inbounds nuw i8, ptr %p, i64 32
  call fastcc void @_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE5closeNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef sret([16 x i8]) align 8 captures(none) dereferenceable(16) %err.i, ptr noalias noundef nonnull align 8 dereferenceable(40) %_8, ptr noalias noundef nonnull align 8 dereferenceable(72) %_5, i8 noundef 11, i8 noundef 2, i8 undef) #23, !noalias !339
  %3 = load i8, ptr %err.i, align 8, !range !105, !noalias !340, !noundef !4
  %4 = icmp eq i8 %3, 0
  br i1 %4, label %bb4.i, label %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit

bb4.i:                                            ; preds = %bb8.i
  %5 = getelementptr inbounds nuw i8, ptr %err.i, i64 1
  %6 = load i8, ptr %5, align 1, !range !111, !noalias !340, !noundef !4
  %_21.i8 = icmp ne i8 %6, 2
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %err.i)
  %. = sext i1 %_21.i8 to i64
  br label %bb3
...
bb3:                                              ; preds = %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, %bb4.i, %_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.thread2
  ...
  %_9.i.i.i.i.i = load i64, ptr %_5, align 8, !range !98, !alias.scope !356, !noundef !4
  %7 = icmp eq i64 %_9.i.i.i.i.i, 0
  br i1 %7, label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit, label %bb6.i.i.i.i.i

bb6.i.i.i.i.i:                                    ; preds = %bb3
  %_10.i.i.i.i.i = shl nuw i64 %_9.i.i.i.i.i, 4
  %_19.i.i.i.i.i = load ptr, ptr %_7.sroa.4.0._5.sroa_idx, align 8, !alias.scope !356, !nonnull !4, !noundef !4
  call void @unir_host_free(ptr noundef nonnull %_19.i.i.i.i.i, i64 noundef range(i64 16, 0) %_10.i.i.i.i.i, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !356
  br label %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(argmem: read) uwtable
define noundef range(i32 0, 1024) i32 @unir_producer_ended(ptr noundef readonly captures(none) %p) unnamed_addr #21 {
start:
...
start:
  ...
  tail call void @llvm.assume(i1 %0)
  tail call void @unir_host_free(ptr noundef nonnull %p, i64 noundef 72, i64 noundef range(i64 1, -9223372036854775807) 8) #23, !noalias !357
  ret void
}
...
bb9.i:                                            ; preds = %start
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_9.i), !noalias !362
  %or.cond.i = icmp ugt i64 %0, 4294967295
  br i1 %or.cond.i, label %bb11.i, label %bb12.i

bb11.i:                                           ; preds = %bb9.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_9.i), !noalias !362
  br label %bb2
...
bb12.i:                                           ; preds = %bb9.i
  ...
  call void @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate10region_map(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_9.i, ptr noalias noundef nonnull align 8 dereferenceable(72) %vat, i32 noundef %_25.i) #23, !noalias !362
  %7 = load i8, ptr %_9.i, align 8, !range !128, !noalias !362, !noundef !4
  %8 = trunc nuw i8 %7 to i1
  br i1 %8, label %bb13.i, label %bb14.i
...
bb14.i:                                           ; preds = %bb12.i
  %9 = getelementptr inbounds nuw i8, ptr %_9.i, i64 8
  %_29.0.i = load i64, ptr %9, align 8, !noalias !362, !noundef !4
  %10 = getelementptr inbounds nuw i8, ptr %_9.i, i64 16
  %_29.1.i = load i64, ptr %10, align 8, !noalias !362, !noundef !4
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_9.i), !noalias !362
...
bb5:                                              ; preds = %bb14.i
  tail call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %_0.i.i.i = tail call noalias noundef ptr @unir_host_alloc(i64 noundef 72, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  %11 = icmp eq ptr %_0.i.i.i, null
  br i1 %11, label %bb6, label %bb7, !prof !150
...
start:
  ...
  %1 = getelementptr inbounds nuw i8, ptr %_10, i64 24
  store i64 0, ptr %_10, align 8
  %_16.sroa.4.0._10.sroa_idx = getelementptr inbounds nuw i8, ptr %_10, i64 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %1, i8 0, i64 48, i1 false)
  store ptr inttoptr (i64 8 to ptr), ptr %_16.sroa.4.0._10.sroa_idx, align 8
  %_16.sroa.5.0._10.sroa_idx = getelementptr inbounds nuw i8, ptr %_10, i64 16
  store i64 0, ptr %_16.sroa.5.0._10.sroa_idx, align 8
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %_11)
  store i16 %substream, ptr %_11, align 2
  %_17 = icmp sgt i64 %timeout_ns, -1
  %_12.sroa.0.0 = zext i1 %_17 to i64
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_20)
  store ptr %_11, ptr %_20, align 8
  ...
  %6 = getelementptr inbounds nuw i8, ptr %p, i64 60
  %7 = getelementptr inbounds nuw i8, ptr %_24.i, i64 1
  br label %bb26.i
...
bb32.i:                                           ; preds = %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i
  ...
  br i1 %12, label %bb9.split.loop.exit48.i, label %bb10.i

bb9.split.loop.exit48.i:                          ; preds = %bb32.i
  %.sroa.4.0.extract.shift.le.i = lshr i64 %11, 8
  %.sroa.4.0.extract.trunc.le.i = trunc i64 %.sroa.4.0.extract.shift.le.i to i8
  br label %bb9.i
...
_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi.exit.i: ; preds = %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i.i, %bb12.i
  %waited.sroa.4.0.i.i = phi i8 [ %_0.i.i29.i, %_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi.exit.i.i ], [ %20, %bb12.i ]
  %switch.selectcmp.i.i = icmp eq i8 %waited.sroa.4.0.i.i, 4
  %switch.select.i.i = select i1 %switch.selectcmp.i.i, i8 8, i8 2
  %switch.selectcmp7.i.i = icmp eq i8 %waited.sroa.4.0.i.i, 3
  %switch.select8.i.i = select i1 %switch.selectcmp7.i.i, i8 6, i8 %switch.select.i.i
...
bb16.i:                                           ; preds = %bb13.i
  %switch.selectcmp22.i = icmp eq i8 %15, 4
...
_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ProducerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatuNCINvMs0_B2_Bz_5writeB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ProducerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatuNCINvMs0_B2_Bz_5writeB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi.exitthread-pre-split, %bb28.i, %bb42.i
  %23 = phi i8 [ %.pr, %_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ProducerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatuNCINvMs0_B2_Bz_5writeB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi.exitthread-pre-split ], [ %10, %bb28.i ], [ %13, %bb42.i ]
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_20)
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %_11)
  %24 = zext i8 %23 to i64
  %switch.gep = getelementptr inbounds nuw [6 x i64], ptr @switch.table.unir_producer_write, i64 0, i64 %24
  %switch.load = load i64, ptr %switch.gep, align 8
  br label %bb9
...
start:
  ...
  %3 = tail call i64 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region8load_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef %.13) #23
...
bb7:                                              ; preds = %bb17
  ...
  %8 = tail call noundef i8 @_RNvXs_CsIEB7taFyf8_10unir_temenNtB4_11TemenRegionNtCsc1i3HueRnCr_14unir_substrate6Region9store_u32(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef %., i32 noundef %_12) #23
  %.not = icmp eq i8 %8, 7
  br i1 %.not, label %bb19, label %bb15

bb19:                                             ; preds = %bb7
  %9 = tail call i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate6notify(ptr noalias noundef nonnull align 8 dereferenceable(72) %s, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %self, i64 noundef %., i32 noundef 1) #23
...
start:
  ...
  %_0 = tail call noundef zeroext i1 @_RNvMsa_NtCscliFh4jUES5_4core3fmtNtB5_9Formatter9write_str(ptr noalias noundef nonnull align 8 dereferenceable(24) %f, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %reltable.intrinsic, i64 noundef %switch.load) #23
  ret i1 %_0
}
...
start:
  %0 = tail call i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate13region_create(ptr noalias noundef nonnull align 8 dereferenceable(72) %vat, i64 noundef %len) #23
  %1 = trunc i64 %0 to i1
...
; Function Attrs: nounwind nonlazybind uwtable
define noundef range(i64 -7, 4294967296) i64 @unir_spawn(ptr noundef %vat, i64 noundef %module, i32 noundef %size_log2, ptr noundef readonly captures(none) %args, i64 noundef %args_len, ptr noundef readonly captures(address) %grants, i32 noundef %grants_n, i64 noundef %fuel) unnamed_addr #1 {
start:
  %_3.i = alloca [24 x i8], align 8
  %endowment = alloca [40 x i8], align 8
  %program = alloca [32 x i8], align 8
  %named = alloca [24 x i8], align 8
  %0 = icmp eq i64 %args_len, 0
  %.args = select i1 %0, ptr inttoptr (i64 1 to ptr), ptr %args
  %1 = icmp eq i32 %grants_n, 0
  %_12 = zext i32 %grants_n to i64
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %named)
  %2 = mul nuw nsw i64 %_12, 24
  br i1 %1, label %bb18.thread, label %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit.i

bb18.thread:                                      ; preds = %start
  store i64 0, ptr %named, align 8
  %3 = getelementptr inbounds nuw i8, ptr %named, i64 8
  store ptr inttoptr (i64 8 to ptr), ptr %3, align 8
  %4 = getelementptr inbounds nuw i8, ptr %named, i64 16
...
bb17:                                             ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit.i
  tail call void @_RNvNtCsksNX8Mxey3D_5alloc7raw_vec12handle_error(i64 noundef 8, i64 %2) #28
  unreachable

bb20.lr.ph:                                       ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit.i
  store i64 %_12, ptr %named, align 8
  %6 = getelementptr inbounds nuw i8, ptr %named, i64 8
  store ptr %_0.i.i.i.i.i, ptr %6, align 8
  %7 = getelementptr inbounds nuw i8, ptr %named, i64 16
  store i64 0, ptr %7, align 8
  %8 = icmp ne ptr %grants, null
  tail call void @llvm.assume(i1 %8)
  %_54 = getelementptr inbounds nuw i8, ptr %grants, i64 %2
  %9 = getelementptr inbounds nuw i8, ptr %_3.i, i64 8
  %10 = getelementptr inbounds nuw i8, ptr %_3.i, i64 16
  br label %bb20

bb20:                                             ; preds = %bb30, %bb20.lr.ph
  %_8224 = phi ptr [ %_0.i.i.i.i.i, %bb20.lr.ph ], [ %_82, %bb30 ]
  %_74 = phi i64 [ 0, %bb20.lr.ph ], [ %16, %bb30 ]
  %iter.sroa.0.022 = phi ptr [ %grants, %bb20.lr.ph ], [ %_66, %bb30 ]
  %_66 = getelementptr inbounds nuw i8, ptr %iter.sroa.0.022, i64 24
  %_22 = load ptr, ptr %iter.sroa.0.022, align 8, !noundef !4
  %11 = getelementptr inbounds nuw i8, ptr %iter.sroa.0.022, i64 8
  %_23 = load i64, ptr %11, align 8, !noundef !4
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_3.i)
  %12 = icmp eq i64 %_23, 0
  %.ptr.i = select i1 %12, ptr inttoptr (i64 1 to ptr), ptr %_22
  call void @_RNvNtNtCscliFh4jUES5_4core3str8converts9from_utf8(ptr noalias noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_3.i, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %.ptr.i, i64 noundef %_23) #23
  %_7.i = load i64, ptr %_3.i, align 8, !range !99, !noundef !4
  %_8.0.i = load ptr, ptr %9, align 8, !nonnull !4, !align !5
  %_8.1.i = load i64, ptr %10, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_3.i)
  %13 = getelementptr inbounds nuw i8, ptr %iter.sroa.0.022, i64 16
  %_25 = load i64, ptr %13, align 8, !noundef !4
  %or.cond = icmp ugt i64 %_25, 4294967295
  br i1 %or.cond, label %bb10, label %bb26

bb19:                                             ; preds = %bb30, %bb18.thread
  %14 = phi ptr [ %3, %bb18.thread ], [ %6, %bb30 ]
  %_85 = phi i64 [ 0, %bb18.thread ], [ %16, %bb30 ]
  %or.cond3 = icmp ugt i64 %module, 4294967295
  br i1 %or.cond3, label %bb10, label %bb23

bb26:                                             ; preds = %bb20
  %15 = trunc nuw i64 %_7.i to i1
  %_73 = trunc nuw i64 %_25 to i32
  br i1 %15, label %bb10, label %bb36

bb36:                                             ; preds = %bb26
  %_81 = load i64, ptr %named, align 8, !range !98, !noundef !4
  %_75 = icmp eq i64 %_74, %_81
  br i1 %_75, label %bb27, label %bb30

bb27:                                             ; preds = %bb36
  call void @_RNvMs3_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecNtCsc1i3HueRnCr_14unir_substrate5GrantE8grow_oneCsdMVUwQQj4R6_9unir_cabi(ptr noalias noundef nonnull align 8 dereferenceable(16) %named) #31
  %_82.pre = load ptr, ptr %6, align 8
  br label %bb30

bb30:                                             ; preds = %bb27, %bb36
  %_82 = phi ptr [ %_8224, %bb36 ], [ %_82.pre, %bb27 ]
  %_79 = getelementptr inbounds nuw %"unir_substrate::Grant<'_>", ptr %_82, i64 %_74
  store ptr %_8.0.i, ptr %_79, align 8
  %_27.sroa.4.0._79.sroa_idx = getelementptr inbounds nuw i8, ptr %_79, i64 8
  store i64 %_8.1.i, ptr %_27.sroa.4.0._79.sroa_idx, align 8
  %_27.sroa.5.0._79.sroa_idx = getelementptr inbounds nuw i8, ptr %_79, i64 16
  store i32 %_73, ptr %_27.sroa.5.0._79.sroa_idx, align 8
  %16 = add i64 %_74, 1
  store i64 %16, ptr %7, align 8
  %_60 = icmp eq ptr %_66, %_54
  br i1 %_60, label %bb19, label %bb20
...
bb23:                                             ; preds = %bb19
  %_70 = trunc nuw i64 %module to i32
...
bb10.i.i:                                         ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit.i.i
  %20 = ptrtoint ptr %_0.i.i.i.i.i.i to i64
...
_RINvXs_NvMNtCsksNX8Mxey3D_5alloc5sliceSp9to_vec_inhNtB5_10ConvertVec6to_vecNtNtBa_5alloc6GlobalECsdMVUwQQj4R6_9unir_cabi.exit: ; preds = %bb10.i.i, %bb23
  ...
  store i32 %size_log2, ptr %23, align 4
  store i64 %args_len, ptr %program, align 8
  %_31.sroa.4.0.program.sroa_idx = getelementptr inbounds nuw i8, ptr %program, i64 8
  store ptr %21, ptr %_31.sroa.4.0.program.sroa_idx, align 8
  %_31.sroa.5.0.program.sroa_idx = getelementptr inbounds nuw i8, ptr %program, i64 16
  store i64 %args_len, ptr %_31.sroa.5.0.program.sroa_idx, align 8
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %endowment)
  %_86 = load ptr, ptr %14, align 8, !nonnull !4, !noundef !4
  store ptr %_86, ptr %endowment, align 8
  %24 = getelementptr inbounds nuw i8, ptr %endowment, i64 8
  store i64 %_85, ptr %24, align 8
  %25 = getelementptr inbounds nuw i8, ptr %endowment, i64 16
  store i64 %fuel, ptr %25, align 8
  %_34.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %endowment, i64 24
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_34.sroa.4.0..sroa_idx, i8 0, i64 16, i1 false)
  %26 = call i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate5spawn(ptr noalias noundef align 8 dereferenceable(72) %vat, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %program, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(40) %endowment) #23
...
bb12:                                             ; preds = %bb6.i.i.i.i11, %_RINvXs_NvMNtCsksNX8Mxey3D_5alloc5sliceSp9to_vec_inhNtB5_10ConvertVec6to_vecNtNtBa_5alloc6GlobalECsdMVUwQQj4R6_9unir_cabi.exit, %bb6.i.i.i.i, %bb10
  %_0.sroa.0.2 = phi i64 [ -7, %bb10 ], [ -7, %bb6.i.i.i.i ], [ %_0.sroa.0.1, %_RINvXs_NvMNtCsksNX8Mxey3D_5alloc5sliceSp9to_vec_inhNtB5_10ConvertVec6to_vecNtNtBa_5alloc6GlobalECsdMVUwQQj4R6_9unir_cabi.exit ], [ %_0.sroa.0.1, %bb6.i.i.i.i11 ]
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %named)
  ret i64 %_0.sroa.0.2
}
...
define noundef range(i64 -4, -9223372036854775808) i64 @unir_vat_args(ptr noundef readonly captures(none) %vat, ptr noundef writeonly captures(none) %buf, i64 noundef %cap) unnamed_addr #25 {
start:
  %0 = getelementptr inbounds nuw i8, ptr %vat, i64 88
  %_7 = load i64, ptr %0, align 8, !noundef !4
  %_14 = icmp sgt i64 %_7, -1
  tail call void @llvm.assume(i1 %_14)
  %_15.not = icmp ugt i64 %_7, %cap
  br i1 %_15.not, label %bb1, label %bb5
...
bb1:                                              ; preds = %bb5, %start
  %_0.sroa.0.0 = phi i64 [ %_11, %bb5 ], [ -4, %start ]
  ret i64 %_0.sroa.0.0
}

; Function Attrs: nounwind nonlazybind uwtable
define noalias noundef ptr @unir_vat_child(i64 noundef %map_base, i64 noundef %map_end) unnamed_addr #1 {
start:
  %_8 = alloca [96 x i8], align 8
  %_3 = alloca [96 x i8], align 8
  call void @llvm.lifetime.start.p0(i64 96, ptr nonnull %_3)
  call void @_RNvMs0_CsIEB7taFyf8_10unir_temenNtB5_8TemenVat5child(ptr noalias noundef nonnull sret([96 x i8]) align 8 captures(none) dereferenceable(96) %_3, i64 noundef %map_base, i64 noundef %map_end) #23
  %0 = load i64, ptr %_3, align 8, !range !100, !noundef !4
  %.not = icmp eq i64 %0, -9223372036854775808
  br i1 %.not, label %bb2, label %bb5

bb5:                                              ; preds = %start
  call void @llvm.lifetime.start.p0(i64 96, ptr nonnull %_8)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(72) %_8, ptr noundef nonnull align 8 dereferenceable(72) %_3, i64 72, i1 false)
  %1 = getelementptr inbounds nuw i8, ptr %_3, i64 72
  %2 = getelementptr inbounds nuw i8, ptr %_8, i64 72
  ...
  tail call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %_0.i.i.i = tail call noalias noundef ptr @unir_host_alloc(i64 noundef 96, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  %3 = icmp eq ptr %_0.i.i.i, null
  br i1 %3, label %bb6, label %bb7, !prof !150

bb2:                                              ; preds = %bb7, %start
  %_0.sroa.0.0 = phi ptr [ %_0.i.i.i, %bb7 ], [ null, %start ]
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %_3)
  ret ptr %_0.sroa.0.0

bb6:                                              ; preds = %bb5
  tail call void @_RNvNtCsksNX8Mxey3D_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 96) #28
  unreachable

bb7:                                              ; preds = %bb5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %_0.i.i.i, ptr noundef nonnull align 8 dereferenceable(96) %_8, i64 96, i1 false)
  call void @llvm.lifetime.end.p0(i64 96, ptr nonnull %_8)
  br label %bb2
}

; Function Attrs: nounwind nonlazybind uwtable
define noalias noundef nonnull ptr @unir_vat_root(i64 noundef %map_base, i64 noundef %map_end) unnamed_addr #1 {
start:
  tail call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %_0.i.i.i = tail call noalias noundef ptr @unir_host_alloc(i64 noundef 96, i64 noundef range(i64 1, -9223372036854775807) 8) #23
  %0 = icmp eq ptr %_0.i.i.i, null
  br i1 %0, label %bb2, label %bb3, !prof !150
...
bb3:                                              ; preds = %start
  ...
  %_6.sroa.0.sroa.4.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 8
  store ptr inttoptr (i64 8 to ptr), ptr %_6.sroa.0.sroa.4.0._14.0.sroa_idx, align 8
  %_6.sroa.0.sroa.5.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 16
  store i64 0, ptr %_6.sroa.0.sroa.5.0._14.0.sroa_idx, align 8
  %_6.sroa.4.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 24
  store i64 %map_base, ptr %_6.sroa.4.0._14.0.sroa_idx, align 8
  %_6.sroa.5.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 32
  store i64 %map_end, ptr %_6.sroa.5.0._14.0.sroa_idx, align 8
  %_6.sroa.6.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 40
  store i64 %map_base, ptr %_6.sroa.6.0._14.0.sroa_idx, align 8
  %_6.sroa.7.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 48
  %_6.sroa.10.0._14.0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 72
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %_6.sroa.7.0._14.0.sroa_idx, i8 -1, i64 24, i1 false)
  store i64 0, ptr %_6.sroa.10.0._14.0.sroa_idx, align 8
  %_6.sroa.10.sroa.4.0._6.sroa.10.0._14.0.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 80
  store ptr inttoptr (i64 1 to ptr), ptr %_6.sroa.10.sroa.4.0._6.sroa.10.0._14.0.sroa_idx.sroa_idx, align 8
  %_6.sroa.10.sroa.5.0._6.sroa.10.0._14.0.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %_0.i.i.i, i64 88
  store i64 0, ptr %_6.sroa.10.sroa.5.0._6.sroa.10.0._14.0.sroa_idx.sroa_idx, align 8
  ret ptr %_0.i.i.i
}

; Function Attrs: nounwind nonlazybind uwtable
define internal void @_RNvMs0_CsIEB7taFyf8_10unir_temenNtB5_8TemenVat4join(ptr dead_on_unwind noalias noundef writable writeonly sret([16 x i8]) align 8 captures(none) dereferenceable(16) %_0, ptr noalias noundef readonly align 8 captures(none) dereferenceable(72) %self, i32 noundef %child) unnamed_addr #1 {
start:
...
bb7:                                              ; preds = %start
  ...
  %_30 = load i64, ptr %0, align 8, !noundef !4
...
bb8:                                              ; preds = %bb7
  %2 = getelementptr inbounds nuw i8, ptr %self, i64 8
  %_31 = load ptr, ptr %2, align 8, !nonnull !4, !noundef !4
  %_34 = getelementptr inbounds nuw %"core::option::Option<i64>", ptr %_31, i64 %i
  %3 = load i64, ptr %_34, align 8, !range !99, !noundef !4
...
start:
  ...
  %w.sroa.6.0.insert.shift.i = shl nuw nsw i64 %w.sroa.6.0.insert.ext.i, 16
  %w.sroa.5.0.insert.ext.i = zext i8 %1 to i64
  %w.sroa.5.0.insert.shift.i = shl nuw nsw i64 %w.sroa.5.0.insert.ext.i, 8
  %w.sroa.0.0.insert.ext.i = zext i8 %0 to i64
  %8 = or disjoint i64 %w.sroa.7.0.insert.shift.i, %w.sroa.0.0.insert.ext.i
  %9 = or disjoint i64 %8, %w.sroa.5.0.insert.shift.i
  %_6 = or disjoint i64 %9, %w.sroa.6.0.insert.shift.i
  %_9 = icmp samesign ugt i64 %_6, 16224
...
bb2:                                              ; preds = %start
  ...
  %20 = or i8 %19, %17
  %21 = icmp eq i8 %20, 0
  br i1 %21, label %bb14.i.i, label %bb5
...
bb14.i.i:                                         ; preds = %bb2
  ...
  %w.sroa.10.0.insert.shift.i44 = shl nuw nsw i64 %w.sroa.10.0.insert.ext.i43, 48
  %w.sroa.9.0.insert.ext.i46 = zext i8 %27 to i64
  %w.sroa.9.0.insert.shift.i47 = shl nuw nsw i64 %w.sroa.9.0.insert.ext.i46, 40
  %w.sroa.8.0.insert.ext.i49 = zext i8 %26 to i64
  %w.sroa.8.0.insert.shift.i50 = shl nuw nsw i64 %w.sroa.8.0.insert.ext.i49, 32
  %w.sroa.7.0.insert.ext.i52 = zext i8 %25 to i64
  %w.sroa.7.0.insert.shift.i53 = shl nuw nsw i64 %w.sroa.7.0.insert.ext.i52, 24
  %w.sroa.6.0.insert.ext.i55 = zext i8 %24 to i64
  %w.sroa.6.0.insert.shift.i56 = shl nuw nsw i64 %w.sroa.6.0.insert.ext.i55, 16
  %w.sroa.5.0.insert.ext.i57 = zext i8 %23 to i64
  %w.sroa.5.0.insert.shift.i58 = shl nuw nsw i64 %w.sroa.5.0.insert.ext.i57, 8
  %w.sroa.0.0.insert.ext.i60 = zext i8 %22 to i64
  %w.sroa.10.0.insert.insert.i45 = or disjoint i64 %w.sroa.5.0.insert.shift.i58, %w.sroa.0.0.insert.ext.i60
  %w.sroa.9.0.insert.insert.i48 = or disjoint i64 %w.sroa.10.0.insert.insert.i45, %w.sroa.6.0.insert.shift.i56
  %w.sroa.8.0.insert.insert.i51 = or disjoint i64 %w.sroa.9.0.insert.insert.i48, %w.sroa.7.0.insert.shift.i53
  %w.sroa.7.0.insert.insert.i54 = or disjoint i64 %w.sroa.8.0.insert.insert.i51, %w.sroa.8.0.insert.shift.i50
  ...
  %w.sroa.10.0.insert.shift.i75 = shl nuw nsw i64 %w.sroa.10.0.insert.ext.i74, 48
  %w.sroa.9.0.insert.ext.i77 = zext i8 %35 to i64
  %w.sroa.9.0.insert.shift.i78 = shl nuw nsw i64 %w.sroa.9.0.insert.ext.i77, 40
  %w.sroa.8.0.insert.ext.i80 = zext i8 %34 to i64
  %w.sroa.8.0.insert.shift.i81 = shl nuw nsw i64 %w.sroa.8.0.insert.ext.i80, 32
  %w.sroa.7.0.insert.ext.i83 = zext i8 %33 to i64
  %w.sroa.7.0.insert.shift.i84 = shl nuw nsw i64 %w.sroa.7.0.insert.ext.i83, 24
  %w.sroa.6.0.insert.ext.i86 = zext i8 %32 to i64
  %w.sroa.6.0.insert.shift.i87 = shl nuw nsw i64 %w.sroa.6.0.insert.ext.i86, 16
  %w.sroa.5.0.insert.ext.i88 = zext i8 %31 to i64
  %w.sroa.5.0.insert.shift.i89 = shl nuw nsw i64 %w.sroa.5.0.insert.ext.i88, 8
  %w.sroa.0.0.insert.ext.i91 = zext i8 %30 to i64
  %w.sroa.10.0.insert.insert.i76 = or disjoint i64 %w.sroa.5.0.insert.shift.i89, %w.sroa.0.0.insert.ext.i91
  %w.sroa.9.0.insert.insert.i79 = or disjoint i64 %w.sroa.10.0.insert.insert.i76, %w.sroa.6.0.insert.shift.i87
  %w.sroa.8.0.insert.insert.i82 = or disjoint i64 %w.sroa.9.0.insert.insert.i79, %w.sroa.7.0.insert.shift.i84
  %w.sroa.7.0.insert.insert.i85 = or disjoint i64 %w.sroa.8.0.insert.insert.i82, %w.sroa.8.0.insert.shift.i81
  ...
  %w.sroa.10.0.insert.shift.i106 = shl nuw nsw i64 %w.sroa.10.0.insert.ext.i105, 48
  %w.sroa.9.0.insert.ext.i108 = zext i8 %43 to i64
  %w.sroa.9.0.insert.shift.i109 = shl nuw nsw i64 %w.sroa.9.0.insert.ext.i108, 40
  %w.sroa.8.0.insert.ext.i111 = zext i8 %42 to i64
  %w.sroa.8.0.insert.shift.i112 = shl nuw nsw i64 %w.sroa.8.0.insert.ext.i111, 32
  %w.sroa.7.0.insert.ext.i114 = zext i8 %41 to i64
  %w.sroa.7.0.insert.shift.i115 = shl nuw nsw i64 %w.sroa.7.0.insert.ext.i114, 24
  %w.sroa.6.0.insert.ext.i117 = zext i8 %40 to i64
  %w.sroa.6.0.insert.shift.i118 = shl nuw nsw i64 %w.sroa.6.0.insert.ext.i117, 16
  %w.sroa.5.0.insert.ext.i119 = zext i8 %39 to i64
  %w.sroa.5.0.insert.shift.i120 = shl nuw nsw i64 %w.sroa.5.0.insert.ext.i119, 8
  %w.sroa.0.0.insert.ext.i122 = zext i8 %38 to i64
  %w.sroa.10.0.insert.insert.i107 = or disjoint i64 %w.sroa.5.0.insert.shift.i120, %w.sroa.0.0.insert.ext.i122
  %w.sroa.9.0.insert.insert.i110 = or disjoint i64 %w.sroa.10.0.insert.insert.i107, %w.sroa.6.0.insert.shift.i118
  %w.sroa.8.0.insert.insert.i113 = or disjoint i64 %w.sroa.9.0.insert.insert.i110, %w.sroa.7.0.insert.shift.i115
  %w.sroa.7.0.insert.insert.i116 = or disjoint i64 %w.sroa.8.0.insert.insert.i113, %w.sroa.8.0.insert.shift.i112
  %w.sroa.5.0.insert.mask.i121 = or i64 %w.sroa.7.0.insert.insert.i116, %w.sroa.9.0.insert.shift.i109
  %w.sroa.0.0.insert.mask.i123 = or i64 %w.sroa.5.0.insert.mask.i121, %w.sroa.10.0.insert.shift.i106
  %w.sroa.0.0.insert.insert.i124 = or i64 %w.sroa.0.0.insert.mask.i123, %w.sroa.11.0.insert.shift.i104
  %.not.i.not = icmp eq i64 %_6, 0
...
bb3.i.i.i.i.i.i.preheader:                        ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit.i.i
  %48 = or disjoint i64 %w.sroa.6.0.insert.shift.i, %w.sroa.5.0.insert.shift.i
  %49 = or disjoint i64 %48, %w.sroa.0.0.insert.ext.i
  %50 = add nsw i64 %49, -1
  %xtraiter = and i64 %w.sroa.0.0.insert.ext.i, 3
  %51 = icmp ult i64 %50, 3
  br i1 %51, label %_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit.loopexit.unr-lcssa, label %bb3.i.i.i.i.i.i.preheader.new

bb3.i.i.i.i.i.i.preheader.new:                    ; preds = %bb3.i.i.i.i.i.i.preheader
  %unroll_iter = sub nsw i64 %_6, %xtraiter
...
bb3.i.i.i.i.i.i:                                  ; preds = %bb3.i.i.i.i.i.i, %bb3.i.i.i.i.i.i.preheader.new
  %52 = phi i64 [ 0, %bb3.i.i.i.i.i.i.preheader.new ], [ %59, %bb3.i.i.i.i.i.i ]
...
_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit.loopexit.unr-lcssa: ; preds = %bb3.i.i.i.i.i.i, %bb3.i.i.i.i.i.i.preheader
  %.unr = phi i64 [ 0, %bb3.i.i.i.i.i.i.preheader ], [ %59, %bb3.i.i.i.i.i.i ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit, label %bb3.i.i.i.i.i.i.epil

bb3.i.i.i.i.i.i.epil:                             ; preds = %bb3.i.i.i.i.i.i.epil, %_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit.loopexit.unr-lcssa
  %61 = phi i64 [ %62, %bb3.i.i.i.i.i.i.epil ], [ %.unr, %_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit.loopexit.unr-lcssa ]
...
_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit: ; preds = %bb3.i.i.i.i.i.i.epil, %_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit.loopexit.unr-lcssa, %bb14.i.i
  ...
  %_25.sroa.0.sroa.4.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 8
  store ptr inttoptr (i64 8 to ptr), ptr %_25.sroa.0.sroa.4.0._0.sroa_idx, align 8
  %_25.sroa.0.sroa.5.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 16
  store i64 0, ptr %_25.sroa.0.sroa.5.0._0.sroa_idx, align 8
  %_25.sroa.4.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 24
  store i64 %window.0, ptr %_25.sroa.4.0._0.sroa_idx, align 8
  %_25.sroa.5.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 32
  store i64 %window.1, ptr %_25.sroa.5.0._0.sroa_idx, align 8
  %_25.sroa.6.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 40
  store i64 %window.0, ptr %_25.sroa.6.0._0.sroa_idx, align 8
  %_25.sroa.7.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 48
  store i64 %w.sroa.0.0.insert.insert.i62, ptr %_25.sroa.7.0._0.sroa_idx, align 8
  %_25.sroa.8.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 56
  store i64 %w.sroa.0.0.insert.insert.i93, ptr %_25.sroa.8.0._0.sroa_idx, align 8
  %_25.sroa.9.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 64
  store i64 %w.sroa.0.0.insert.insert.i124, ptr %_25.sroa.9.0._0.sroa_idx, align 8
  %_25.sroa.10.0._0.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 72
  store i64 %_6, ptr %_25.sroa.10.0._0.sroa_idx, align 8
  %_25.sroa.10.sroa.4.0._25.sroa.10.0._0.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 80
  store ptr %64, ptr %_25.sroa.10.sroa.4.0._25.sroa.10.0._0.sroa_idx.sroa_idx, align 8
  %_25.sroa.10.sroa.5.0._25.sroa.10.0._0.sroa_idx.sroa_idx = getelementptr inbounds nuw i8, ptr %_0, i64 88
  store i64 %_6, ptr %_25.sroa.10.sroa.5.0._25.sroa.10.0._0.sroa_idx.sroa_idx, align 8
  br label %bb10

bb10:                                             ; preds = %_RNvXs_NtNtCsksNX8Mxey3D_5alloc3vec21spec_from_iter_nestedINtB6_3VechEINtB4_18SpecFromIterNestedhINtNtNtNtCscliFh4jUES5_4core4iter8adapters3map3MapINtNtNtB1F_3ops5range5RangejENCNvMs0_CsIEB7taFyf8_10unir_temenNtB2V_8TemenVat5childs_0EE9from_iterB2V_.exit, %bb5
  ret void
}

; Function Attrs: cold noinline nounwind nonlazybind uwtable
define internal void @_RNvMs3_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecAmj4_E8grow_oneCsIEB7taFyf8_10unir_temen(ptr noalias noundef align 8 captures(none) dereferenceable(16) %self) unnamed_addr #19 {
start:
...
; Function Attrs: cold nounwind nonlazybind uwtable
define internal fastcc void @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner11finish_growCsIEB7taFyf8_10unir_temen(ptr dead_on_unwind noalias noundef nonnull writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) initializes((0, 8)) %_0, ptr noalias noundef nonnull readonly align 8 captures(none) dereferenceable(16) %self, i64 noundef range(i64 4, 0) %cap, i64 noundef range(i64 1, 9) %elem_layout.0, i64 noundef range(i64 1, 17) %elem_layout.1) unnamed_addr #20 {
start:
...
bb14:                                             ; preds = %bb11
  ...
  br i1 %2, label %bb4.thread, label %bb4.i.i
...
bb4.i.i:                                          ; preds = %bb14
  tail call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %3 = tail call noundef ptr @_RNvCs1Y7DaGC1cwg_7___rustc12___rust_alloc(i64 noundef %_17.0.i, i64 noundef range(i64 1, -9223372036854775807) %elem_layout.0) #23
  br label %bb4
...
_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator4grow.exit: ; preds = %bb11
  ...
  %_12.i.i = icmp uge i64 %_17.0.i, %_31
  tail call void @llvm.assume(i1 %_12.i.i)
  %raw_ptr.i.i = tail call noundef ptr @_RNvCs1Y7DaGC1cwg_7___rustc14___rust_realloc(ptr noundef nonnull %_40, i64 noundef range(i64 1, 0) %_31, i64 noundef range(i64 1, 9) %elem_layout.0, i64 noundef %_17.0.i) #23
  br label %bb4

bb4:                                              ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator4grow.exit, %bb4.i.i
  %_0.sroa.0.0.i.i.pn = phi ptr [ %raw_ptr.i.i, %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator4grow.exit ], [ %3, %bb4.i.i ]
...
bb6:                                              ; preds = %bb4, %bb4.thread
  %_0.sroa.0.0.i.i.pn15 = phi ptr [ %_14.i.i, %bb4.thread ], [ %_0.sroa.0.0.i.i.pn, %bb4 ]
  %7 = getelementptr inbounds nuw i8, ptr %_0, i64 8
  store ptr %_0.sroa.0.0.i.i.pn15, ptr %7, align 8
  br label %bb8

bb8:                                              ; preds = %bb6, %bb5, %start
  %.sink16 = phi i64 [ 16, %bb6 ], [ 16, %bb5 ], [ 8, %start ]
  %_17.0.i.sink = phi i64 [ %_17.0.i, %bb6 ], [ %_17.0.i, %bb5 ], [ 0, %start ]
  %storemerge7 = phi i64 [ 0, %bb6 ], [ 1, %bb5 ], [ 1, %start ]
  %8 = getelementptr inbounds nuw i8, ptr %_0, i64 %.sink16
...
; Function Attrs: cold noinline nounwind nonlazybind uwtable
define internal void @_RNvMs3_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEE8grow_oneCsIEB7taFyf8_10unir_temen(ptr noalias noundef align 8 captures(none) dereferenceable(16) %self) unnamed_addr #19 {
start:
  %_16.i = alloca [24 x i8], align 8
  %_5 = load i64, ptr %self, align 8, !range !98, !noundef !4
...
; Function Attrs: nounwind nonlazybind uwtable
define internal void @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate10region_map(ptr dead_on_unwind noalias noundef writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) initializes((0, 1)) %_0, ptr noalias noundef align 8 captures(none) dereferenceable(72) %self, i32 noundef %region) unnamed_addr #1 {
start:
...
bb4:                                              ; preds = %bb13
  %r.i = tail call noundef i64 @__vm_region_map(i32 noundef range(i32 0, -2147483648) %region, i64 noundef %_15, i64 noundef 0, i64 noundef %span.sroa.0.0, i32 noundef 3) #23
...
; Function Attrs: nounwind nonlazybind uwtable
define internal range(i64 0, 9223372032559808514) i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate13region_create(ptr noalias noundef align 8 captures(none) dereferenceable(72) %self, i64 noundef %len) unnamed_addr #1 {
start:
...
bb8:                                              ; preds = %start
  ...
  br i1 %_19.1, label %bb7, label %bb14, !prof !150
...
bb2:                                              ; preds = %bb14
  %2 = tail call noundef i64 @__vm_region_create(i64 noundef %_5.sroa.5.0) #23
...
; Function Attrs: nounwind nonlazybind uwtable
define internal { i1, i8 } @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate4wait(ptr noalias noundef readnone align 8 captures(none) dereferenceable(72) %self, ptr noalias noundef readonly align 8 captures(none) dereferenceable(16) %region, i64 noundef %off, i32 noundef %expected, i64 noundef range(i64 0, 2) %0, i64 %1) unnamed_addr #1 {
start:
  %_5.i = and i64 %off, 3
...
bb11:                                             ; preds = %bb9
  ...
  %5 = tail call noundef i32 @__vm_wait32(i64 noundef %_13.i, i32 noundef %expected, i64 noundef %spec.store.select) #23
  %6 = icmp ugt i32 %5, 2
...
bb10:                                             ; preds = %bb9
  %7 = tail call noundef i32 @__vm_wait32(i64 noundef %_13.i, i32 noundef %expected, i64 noundef 1000000000) #23
  %8 = icmp ult i32 %7, 3
...
; Function Attrs: nounwind nonlazybind uwtable
define internal range(i64 256, -4294901760) i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate5spawn(ptr noalias noundef align 8 captures(none) dereferenceable(72) %self, ptr dead_on_return noalias noundef readonly align 8 captures(none) dereferenceable(32) %program, ptr noalias noundef readonly align 8 captures(none) dereferenceable(40) %endowment) unnamed_addr #1 {
start:
  %t.i.i.i.i21 = alloca [4 x i8], align 4
  %t.i.i.i.i = alloca [4 x i8], align 4
  %_179 = alloca [24 x i8], align 8
  %_124 = alloca [24 x i8], align 8
  ...
  %1 = getelementptr inbounds nuw i8, ptr %self, i64 48
  %_95 = load i64, ptr %1, align 8, !noundef !4
  %_93.not = icmp ugt i64 %_94, %_95
  br i1 %_93.not, label %bb27, label %bb29
...
bb29:                                             ; preds = %start
  ...
  br i1 %_96.not, label %bb27, label %bb30
...
bb30:                                             ; preds = %bb29
  ...
  br i1 %_4.not, label %bb27, label %bb1

bb1:                                              ; preds = %bb30
  %6 = getelementptr inbounds nuw i8, ptr %program, i64 16
  %_6 = load i64, ptr %6, align 8, !noundef !4
  %_101 = icmp sgt i64 %_6, -1
  tail call void @llvm.assume(i1 %_101)
  %_5 = icmp samesign ugt i64 %_6, 16224
  br i1 %_5, label %bb27, label %bb4
...
bb1.i.i:                                          ; preds = %bb3.i.i, %bb4
  ...
  br i1 %exitcond.not.i.not.not.not.not.i.not, label %bb27, label %bb3.i.i
...
bb35:                                             ; preds = %bb3.i.i
  %n.i22 = call noundef i32 @__vm_cap_count() #23
  %smax.i.i23 = call i32 @llvm.smax.i32(i32 %n.i22, i32 0)
  br label %bb1.i.i24

bb1.i.i24:                                        ; preds = %bb3.i.i28, %bb35
  %11 = phi i32 [ %12, %bb3.i.i28 ], [ 0, %bb35 ]
  %exitcond.not.i.not.not.not.not.i25.not = icmp eq i32 %11, %smax.i.i23
  br i1 %exitcond.not.i.not.not.not.not.i25.not, label %bb27, label %bb3.i.i28
...
bb37:                                             ; preds = %bb3.i.i28
  ...
  %_20 = load i32, ptr %13, align 8, !noundef !4
  %_113 = icmp slt i32 %_20, 0
  br i1 %_113, label %bb27, label %bb39

bb39:                                             ; preds = %bb37
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %payload)
  %_24 = add nuw nsw i64 %_6, 32
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_124)
  call fastcc void @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsIEB7taFyf8_10unir_temen(ptr noalias noundef sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_124, i64 noundef %_24, i64 noundef 1, i64 noundef 1) #23
  %_125 = load i64, ptr %_124, align 8, !range !99, !noundef !4
  %14 = trunc nuw i64 %_125 to i1
  %15 = getelementptr inbounds nuw i8, ptr %_124, i64 8
  %_128.0 = load i64, ptr %15, align 8, !range !100, !noundef !4
  %16 = getelementptr inbounds nuw i8, ptr %_124, i64 16
  br i1 %14, label %bb41, label %bb42, !prof !150

bb41:                                             ; preds = %bb39
  %_128.1 = load i64, ptr %16, align 8
  call void @_RNvNtCsksNX8Mxey3D_5alloc7raw_vec12handle_error(i64 noundef %_128.0, i64 %_128.1) #28
  unreachable

bb42:                                             ; preds = %bb39
  %_123.1 = load ptr, ptr %16, align 8, !nonnull !4, !noundef !4
  %_127 = icmp samesign ule i64 %_24, %_128.0
  call void @llvm.assume(i1 %_127)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_124)
  store i64 %_128.0, ptr %payload, align 8
  %17 = getelementptr inbounds nuw i8, ptr %payload, i64 8
  store ptr %_123.1, ptr %17, align 8
  %18 = getelementptr inbounds nuw i8, ptr %payload, i64 16
  store i64 0, ptr %18, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %_30)
  store i64 %_6, ptr %_30, align 8
...
_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit: ; preds = %bb1.i.i33, %bb42
  %_10.i.i.1 = phi i64 [ %_10.i.i, %bb42 ], [ %_10.i.i.1.pre, %bb1.i.i33 ]
...
_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.1: ; preds = %bb1.i.i33.1, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit
  %_10.i.i.2 = phi i64 [ %_10.i.i.1, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit ], [ %_10.i.i.2.pre, %bb1.i.i33.1 ]
  %_28.i.1 = phi ptr [ %_28.i, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit ], [ %_28.i.1.pre, %bb1.i.i33.1 ]
  %_23.i.1 = phi i64 [ %19, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit ], [ %_23.pre.i.1, %bb1.i.i33.1 ]
...
_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.2: ; preds = %bb1.i.i33.2, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.1
  %_28.i.2 = phi ptr [ %_28.i.1, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.1 ], [ %_28.i.2.pre, %bb1.i.i33.2 ]
  %_23.i.2 = phi i64 [ %20, %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.1 ], [ %_23.pre.i.2, %bb1.i.i33.2 ]
  ...
  call fastcc void @_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen(ptr noalias noundef align 8 dereferenceable(24) %payload, ptr noundef nonnull %_169, ptr noundef %_173) #23
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %grants)
  %23 = getelementptr inbounds nuw i8, ptr %endowment, i64 8
  %_91.1 = load i64, ptr %23, align 8, !noundef !4
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %_179)
  call fastcc void @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsIEB7taFyf8_10unir_temen(ptr noalias noundef sret([24 x i8]) align 8 captures(none) dereferenceable(24) %_179, i64 noundef %_91.1, i64 noundef 4, i64 noundef 16) #23
  %_180 = load i64, ptr %_179, align 8, !range !99, !noundef !4
  %24 = trunc nuw i64 %_180 to i1
  %25 = getelementptr inbounds nuw i8, ptr %_179, i64 8
  %_183.0 = load i64, ptr %25, align 8, !range !100, !noundef !4
  %26 = getelementptr inbounds nuw i8, ptr %_179, i64 16
  br i1 %24, label %bb49, label %bb50, !prof !150

bb49:                                             ; preds = %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.2
  %_183.1 = load i64, ptr %26, align 8
  call void @_RNvNtCsksNX8Mxey3D_5alloc7raw_vec12handle_error(i64 noundef %_183.0, i64 %_183.1) #28
  unreachable

bb50:                                             ; preds = %_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen.exit.2
  %_178.1 = load ptr, ptr %26, align 8, !nonnull !4, !noundef !4
  %_182 = icmp ule i64 %_91.1, %_183.0
  call void @llvm.assume(i1 %_182)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %_179)
  store i64 %_183.0, ptr %grants, align 8
  %27 = getelementptr inbounds nuw i8, ptr %grants, i64 8
  store ptr %_178.1, ptr %27, align 8
  %28 = getelementptr inbounds nuw i8, ptr %grants, i64 16
  store i64 0, ptr %28, align 8
  %_48.0 = load ptr, ptr %endowment, align 8, !nonnull !4, !align !6, !noundef !4
  %_191.idx = mul nuw nsw i64 %_91.1, 24
  %_191 = getelementptr inbounds nuw i8, ptr %_48.0, i64 %_191.idx
  %_19766 = icmp eq i64 %_91.1, 0
  br i1 %_19766, label %bb51, label %bb52

bb52:                                             ; preds = %bb58, %bb50
  %_22277 = phi ptr [ %_222, %bb58 ], [ %_178.1, %bb50 ]
  %_214 = phi i64 [ %33, %bb58 ], [ 0, %bb50 ]
  %iter1.sroa.0.067 = phi ptr [ %_203, %bb58 ], [ %_48.0, %bb50 ]
  %_203 = getelementptr inbounds nuw i8, ptr %iter1.sroa.0.067, i64 24
  %29 = getelementptr inbounds nuw i8, ptr %iter1.sroa.0.067, i64 16
  %_54 = load i32, ptr %29, align 8, !noundef !4
  %_205 = icmp slt i32 %_54, 0
  br i1 %_205, label %bb21, label %bb54

bb51.loopexit:                                    ; preds = %bb58
  %_223.pre = load ptr, ptr %27, align 8
  br label %bb51

bb51:                                             ; preds = %bb51.loopexit, %bb50
  %_71 = phi i64 [ %33, %bb51.loopexit ], [ 0, %bb50 ]
  %_223 = phi ptr [ %_223.pre, %bb51.loopexit ], [ %_178.1, %bb50 ]
  %_7.i = icmp eq i64 %_94, 0
  %.self.i = call i64 @llvm.umin.i64(i64 %_94, i64 9223372036854775807)
  %_0.sroa.0.0.i34 = select i1 %_7.i, i64 1, i64 %.self.i
  %_66 = sext i32 %h.i.i.i.i29 to i64
  %_67 = zext nneg i32 %_20 to i64
  %_68 = ptrtoint ptr %_223 to i64
  %_224 = icmp ult i64 %_71, 576460752303423488
  call void @llvm.assume(i1 %_224)
  %30 = getelementptr inbounds nuw i8, ptr %program, i64 28
  %_73 = load i32, ptr %30, align 4, !noundef !4
  %_72 = zext i32 %_73 to i64
  %_225 = load ptr, ptr %17, align 8, !nonnull !4, !noundef !4
  %_74 = ptrtoint ptr %_225 to i64
  %_77 = load i64, ptr %18, align 8, !noundef !4
  %_226 = icmp sgt i64 %_77, -1
  call void @llvm.assume(i1 %_226)
  %h6 = call noundef i64 @__vm_instantiate_detached(i32 noundef %h.i.i.i.i, i64 noundef %_66, i64 noundef %_67, i64 noundef %_68, i64 noundef %_71, i64 noundef 0, i64 noundef %_72, i64 noundef %_0.sroa.0.0.i34, i64 noundef %_74, i64 noundef %_77) #23
  %_78 = icmp slt i64 %h6, 0
  br i1 %_78, label %bb21, label %bb14

bb54:                                             ; preds = %bb52
  %_92.0 = load ptr, ptr %iter1.sroa.0.067, align 8, !nonnull !4, !align !5, !noundef !4
  %31 = getelementptr inbounds nuw i8, ptr %iter1.sroa.0.067, i64 8
  %_92.1 = load i64, ptr %31, align 8, !noundef !4
  %32 = ptrtoint ptr %_92.0 to i64
  %_58 = trunc i64 %32 to i32
  %_60 = trunc i64 %_92.1 to i32
  %_221 = load i64, ptr %grants, align 8, !range !98, !noundef !4
  %_215 = icmp eq i64 %_214, %_221
  br i1 %_215, label %bb55, label %bb58
...
bb55:                                             ; preds = %bb54
  ...
  %_222.pre = load ptr, ptr %27, align 8
  br label %bb58

bb58:                                             ; preds = %bb55, %bb54
  %_222 = phi ptr [ %_22277, %bb54 ], [ %_222.pre, %bb55 ]
  %_219 = getelementptr inbounds nuw [4 x i32], ptr %_222, i64 %_214
  store i32 %_58, ptr %_219, align 4
  %_57.sroa.4.0._219.sroa_idx = getelementptr inbounds nuw i8, ptr %_219, i64 4
  store i32 %_60, ptr %_57.sroa.4.0._219.sroa_idx, align 4
  %_57.sroa.5.0._219.sroa_idx = getelementptr inbounds nuw i8, ptr %_219, i64 8
  store i32 %_54, ptr %_57.sroa.5.0._219.sroa_idx, align 4
  %_57.sroa.6.0._219.sroa_idx = getelementptr inbounds nuw i8, ptr %_219, i64 12
  store i32 0, ptr %_57.sroa.6.0._219.sroa_idx, align 4
  %33 = add i64 %_214, 1
  store i64 %33, ptr %28, align 8
  %_197 = icmp eq ptr %_203, %_191
  br i1 %_197, label %bb51.loopexit, label %bb52
...
bb14:                                             ; preds = %bb51
  ...
  %39 = getelementptr inbounds nuw i8, ptr %self, i64 8
  %_230 = load ptr, ptr %39, align 8, !nonnull !4, !noundef !4
  %40 = getelementptr inbounds nuw i8, ptr %self, i64 16
  %_229 = load i64, ptr %40, align 8, !noundef !4
  %_233.idx = shl nuw nsw i64 %_229, 4
  %_233 = getelementptr inbounds nuw i8, ptr %_230, i64 %_233.idx
  %_295.i = icmp eq i64 %_229, 0
  br i1 %_295.i, label %bb16, label %bb21.i
...
bb7.i:                                            ; preds = %bb21.i
  ...
  %41 = add nuw nsw i64 %i.sroa.0.07.i, 1
  %_29.i = icmp eq ptr %_36.i, %_233
  br i1 %_29.i, label %bb16, label %bb21.i

bb17:                                             ; preds = %bb21.i
  %_14.i = icmp ult i64 %i.sroa.0.07.i, %_229
  call void @llvm.assume(i1 %_14.i)
  br label %bb18

bb16:                                             ; preds = %bb7.i, %bb14
  %_244 = load i64, ptr %self, align 8, !range !98, !noundef !4
  %_238 = icmp eq i64 %_229, %_244
  br i1 %_238, label %bb59, label %bb62

bb59:                                             ; preds = %bb16
  call void @_RNvMs3_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEE8grow_oneCsIEB7taFyf8_10unir_temen(ptr noalias noundef nonnull align 8 dereferenceable(16) %self) #31
  %_245.pre = load ptr, ptr %39, align 8
  br label %bb62

bb62:                                             ; preds = %bb59, %bb16
  %_245 = phi ptr [ %_230, %bb16 ], [ %_245.pre, %bb59 ]
  %_242 = getelementptr inbounds nuw %"core::option::Option<i64>", ptr %_245, i64 %_229
  store i64 0, ptr %_242, align 8
  %42 = add nsw i64 %_229, 1
  store i64 %42, ptr %40, align 8
  br label %bb18

bb18:                                             ; preds = %bb62, %bb17
  %_251 = phi ptr [ %_230, %bb17 ], [ %_245, %bb62 ]
  %_250 = phi i64 [ %_229, %bb17 ], [ %42, %bb62 ]
  %i.sroa.0.0 = phi i64 [ %i.sroa.0.07.i, %bb17 ], [ %_229, %bb62 ]
  %_252 = icmp ult i64 %i.sroa.0.0, %_250
  br i1 %_252, label %bb63, label %panic

bb63:                                             ; preds = %bb18
  %_87 = getelementptr inbounds nuw %"core::option::Option<i64>", ptr %_251, i64 %i.sroa.0.0
...
_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen12TemenProgramEBI_.exit52: ; preds = %bb6.i.i.i.i.i50, %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VechEECsIEB7taFyf8_10unir_temen.exit48
  ...
  %47 = or i64 %_89, -9223372036854775808
  br label %bb28

panic:                                            ; preds = %bb18
  call void @_RNvNtCscliFh4jUES5_4core9panicking18panic_bounds_check(i64 noundef %i.sroa.0.0, i64 noundef %_250, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_11e2992a5b9c8f277d4a00890b54e14e.91) #29
  unreachable

bb28:                                             ; preds = %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen12TemenProgramEBI_.exit52, %bb6.i.i.i.i.i, %bb27
  %_0.sroa.0.2 = phi i64 [ 0, %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen12TemenProgramEBI_.exit52 ], [ 1, %bb27 ], [ 1, %bb6.i.i.i.i.i ]
  %_0.sroa.9.0.insert.insert = phi i64 [ %47, %_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen12TemenProgramEBI_.exit52 ], [ %_0.sroa.9.0, %bb27 ], [ %_0.sroa.9.0, %bb6.i.i.i.i.i ]
  %_0.sroa.0.0.insert.insert = or i64 %_0.sroa.9.0.insert.insert, %_0.sroa.0.2
  ret i64 %_0.sroa.0.0.insert.insert
}

; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @_RNvMs4_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsIEB7taFyf8_10unir_temen(ptr dead_on_unwind noalias noundef nonnull writable writeonly sret([24 x i8]) align 8 captures(none) dereferenceable(24) initializes((0, 16)) %_0, i64 noundef %capacity, i64 noundef range(i64 1, 5) %elem_layout.0, i64 noundef range(i64 1, 17) %elem_layout.1) unnamed_addr #1 {
start:
  %_7.i = add nsw i64 %elem_layout.0, -1
  %_9.i = add nuw nsw i64 %_7.i, %elem_layout.1
  %_11.i = sub nsw i64 0, %elem_layout.0
  ...
  %_22.i = icmp ugt i64 %_17.0.i, %_23.i
  %or.cond.i = select i1 %_17.1.i, i1 true, i1 %_22.i
  br i1 %or.cond.i, label %bb13, label %bb14, !prof !101
...
bb14:                                             ; preds = %start
  %2 = icmp eq i64 %_17.0.i, 0
  br i1 %2, label %bb2, label %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit
...
_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit: ; preds = %bb14
  tail call void @_RNvCs1Y7DaGC1cwg_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #23
  %5 = tail call noundef ptr @_RNvCs1Y7DaGC1cwg_7___rustc12___rust_alloc(i64 noundef %_17.0.i, i64 noundef range(i64 1, -9223372036854775807) %elem_layout.0) #23
  %6 = icmp eq ptr %5, null
  br i1 %6, label %bb9, label %bb10

bb9:                                              ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit
  %7 = getelementptr inbounds nuw i8, ptr %_0, i64 8
  store i64 %elem_layout.0, ptr %7, align 8
  %8 = getelementptr inbounds nuw i8, ptr %_0, i64 16
  store i64 %_17.0.i, ptr %8, align 8
  br label %bb11

bb10:                                             ; preds = %_RNvXs_NtCsksNX8Mxey3D_5alloc5allocNtB4_6GlobalNtNtCscliFh4jUES5_4core5alloc9Allocator8allocate.exit
  %9 = icmp sgt i64 %capacity, -1
...
; Function Attrs: nounwind nonlazybind uwtable
define internal fastcc void @_RNvXs2_NtNtCsksNX8Mxey3D_5alloc3vec11spec_extendINtB7_3VechEINtB5_10SpecExtendRhINtNtNtCscliFh4jUES5_4core5slice4iter4IterhEE11spec_extendCsIEB7taFyf8_10unir_temen(ptr noalias noundef nonnull align 8 captures(none) dereferenceable(24) %self, ptr noundef nonnull %iterator.0, ptr noundef nonnull %iterator.1) unnamed_addr #1 {
start:
  %0 = ptrtoint ptr %iterator.1 to i64
...
bb1.i:                                            ; preds = %start
  tail call fastcc void @_RINvNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecINtB8_11RawVecInnerpE7reserve21do_reserve_and_handleNtNtBa_5alloc6GlobalECsIEB7taFyf8_10unir_temen(ptr noalias noundef nonnull align 8 dereferenceable(24) %self, i64 noundef %_3.i, i64 noundef %2) #23
  %_23.pre = load i64, ptr %3, align 8
  br label %_RNvMs_NtCsksNX8Mxey3D_5alloc3vecINtB4_3VechE7reserveCsIEB7taFyf8_10unir_temen.exit

_RNvMs_NtCsksNX8Mxey3D_5alloc3vecINtB4_3VechE7reserveCsIEB7taFyf8_10unir_temen.exit: ; preds = %bb1.i, %start
  %_23 = phi i64 [ %_3.i, %start ], [ %_23.pre, %bb1.i ]
  %_27 = icmp sgt i64 %_23, -1
  tail call void @llvm.assume(i1 %_27)
  %4 = getelementptr inbounds nuw i8, ptr %self, i64 8
  %_28 = load ptr, ptr %4, align 8, !nonnull !4, !noundef !4
  %_25 = getelementptr inbounds nuw i8, ptr %_28, i64 %_23
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %_25, ptr nonnull align 1 %iterator.0, i64 %2, i1 false)
  %5 = add i64 %_23, %2
...
bb2:                                              ; preds = %bb22.i, %start
  %_0.sroa.5.0.i.ph = phi i64 [ undef, %start ], [ %_37.1.i, %bb22.i ]
  %_0.sroa.0.0.i.ph = phi i64 [ 0, %start ], [ %_37.0.i, %bb22.i ]
  tail call void @_RNvNtCsksNX8Mxey3D_5alloc7raw_vec12handle_error(i64 noundef %_0.sroa.0.0.i.ph, i64 %_0.sroa.5.0.i.ph) #28
  unreachable
...
; Function Attrs: nounwind nonlazybind uwtable
define internal range(i64 512, -4294965248) i64 @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate6notify(ptr noalias noundef readnone align 8 captures(none) dereferenceable(72) %self, ptr noalias noundef readonly align 8 captures(none) dereferenceable(16) %region, i64 noundef %off, i32 noundef %0) unnamed_addr #1 {
start:
  %_5.i = and i64 %off, 3
...
; Function Attrs: nounwind nonlazybind uwtable
define internal { i32, i32 } @_RNvXs1_CsIEB7taFyf8_10unir_temenNtB5_8TemenVatNtCsc1i3HueRnCr_14unir_substrate9Substrate7endowed(ptr noalias noundef readonly align 8 captures(none) dereferenceable(72) %self, ptr noalias noundef nonnull readonly align 1 captures(address, read_provenance) %name.0, i64 noundef %name.1) unnamed_addr #1 {
start:
  %h.i = tail call noundef i32 @__vm_cap_resolve(ptr noundef nonnull readonly align 1 %name.0, i64 noundef %name.1) #23
  %_6.i = icmp sgt i32 %h.i, -1
  %_0.sroa.0.0 = zext i1 %_6.i to i32
  %0 = insertvalue { i32, i32 } poison, i32 %_0.sroa.0.0, 0
  %1 = insertvalue { i32, i32 } %0, i32 %h.i, 1
  ret { i32, i32 } %1
}
...
start:
  ...
  br i1 %or.cond19, label %bb6, label %bb12, !prof !101
...
bb29:                                             ; preds = %bb26
  tail call void @_RNvNtNtCscliFh4jUES5_4core5slice5index16slice_index_fail(i64 noundef %t, i64 noundef %_41, i64 noundef %dst.1, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @alloc_11e2992a5b9c8f277d4a00890b54e14e.91) #29
  unreachable
...
start:
  ...
  br i1 %or.cond17, label %bb6, label %bb12, !prof !101
...
bb1.i:                                            ; preds = %start
  ...
  %_11.i = icmp ugt i64 %_16.0.i, %_12.i
  %or.cond = select i1 %_16.1.i, i1 true, i1 %_11.i
  br i1 %or.cond, label %bb4, label %bb5, !prof !101
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none) uwtable
define internal { i1, i8 } @_RNvMs4_CsdT7xHiCjqae_9unir_wireNtB5_8Terminal15decode_consumer(i32 noundef %w) unnamed_addr #24 {
start:
...
bb14.i:                                           ; preds = %bb4.i
  ...
  %3 = getelementptr inbounds nuw i8, ptr @alloc_cc193f9e0c79ce36721b88a4026725d4.113, i64 %_12.i
  %_14.i = load i8, ptr %3, align 1, !range !231, !noundef !4
...
attributes #19 = { cold noinline nounwind nonlazybind uwtable "probe-stack"="inline-asm" "target-cpu"="x86-64" }
...
attributes #25 = { mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(readwrite, inaccessiblemem: write) uwtable "probe-stack"="inline-asm" "target-cpu"="x86-64" }
...
!102 = !{!103}
!103 = distinct !{!103, !104, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!104 = distinct !{!104, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!105 = !{i8 0, i8 5}
!106 = !{!107, !108}
!107 = distinct !{!107, !104, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!108 = distinct !{!108, !104, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!109 = !{!107}
!110 = !{!107, !103, !108}
!111 = !{i8 0, i8 4}
!112 = !{!113}
!113 = distinct !{!113, !114, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_1"}
!114 = distinct !{!114, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!115 = !{!116}
!116 = distinct !{!116, !117, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!117 = distinct !{!117, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!118 = !{!119}
!119 = distinct !{!119, !120, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!120 = distinct !{!120, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!121 = !{!122}
!122 = distinct !{!122, !123, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi: %self"}
!123 = distinct !{!123, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi"}
!124 = !{!125}
!125 = distinct !{!125, !126, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi: %self"}
!126 = distinct !{!126, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi"}
!127 = !{!125, !122, !119, !116, !113}
!128 = !{i8 0, i8 2}
!129 = !{!130}
!130 = distinct !{!130, !131, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4ringNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!131 = distinct !{!131, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4ringNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!132 = !{!133}
!133 = distinct !{!133, !131, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4ringNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!134 = !{!135, !137}
!135 = distinct !{!135, !136, !"_RNvXs8_NtCsksNX8Mxey3D_5alloc5boxedINtB5_3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirConsumerENtNtNtCscliFh4jUES5_4core3ops4drop4Drop4dropBJ_: %self"}
!136 = distinct !{!136, !"_RNvXs8_NtCsksNX8Mxey3D_5alloc5boxedINtB5_3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirConsumerENtNtNtCscliFh4jUES5_4core3ops4drop4Drop4dropBJ_"}
!137 = distinct !{!137, !138, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc5boxed3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirConsumerEEB1h_: %_1"}
!138 = distinct !{!138, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc5boxed3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirConsumerEEB1h_"}
!139 = !{!140, !142}
!140 = distinct !{!140, !141, !"_RNCNvCsdMVUwQQj4R6_9unir_cabi18unir_consumer_open0B3_: %_0"}
!141 = distinct !{!141, !"_RNCNvCsdMVUwQQj4R6_9unir_cabi18unir_consumer_open0B3_"}
!142 = distinct !{!142, !141, !"_RNCNvCsdMVUwQQj4R6_9unir_cabi18unir_consumer_open0B3_: %_1"}
!143 = !{!144, !146, !140, !142}
!144 = distinct !{!144, !145, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4openNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!145 = distinct !{!145, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4openNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!146 = distinct !{!146, !145, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4openNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!147 = !{!144, !140, !142}
!148 = !{i8 0, i8 6}
!149 = !{!146, !140, !142}
!150 = !{!"branch_weights", !"expected", i32 1, i32 2000}
!151 = !{!152}
!152 = distinct !{!152, !153, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4ringNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!153 = distinct !{!153, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4ringNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!154 = !{!155}
!155 = distinct !{!155, !153, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4ringNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!156 = !{!157}
!157 = distinct !{!157, !158, !"_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatNtB2_5FrameNCINvMs1_B2_Bz_4readB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi: %_0"}
!158 = distinct !{!158, !"_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatNtB2_5FrameNCINvMs1_B2_Bz_4readB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi"}
!159 = !{!160}
!160 = distinct !{!160, !158, !"_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatNtB2_5FrameNCINvMs1_B2_Bz_4readB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi: %x"}
!161 = !{!157, !160, !162, !163}
!162 = distinct !{!162, !158, !"_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatNtB2_5FrameNCINvMs1_B2_Bz_4readB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi: %s"}
!163 = distinct !{!163, !158, !"_RINvCsiYG6txRjdvL_9unir_edge8blockingINtB2_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionEBO_NtBQ_8TemenVatNtB2_5FrameNCINvMs1_B2_Bz_4readB1w_Es_0ECsdMVUwQQj4R6_9unir_cabi: argument 3"}
!164 = !{!165, !160}
!165 = distinct !{!165, !166, !"_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi: %self"}
!166 = distinct !{!166, !"_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi"}
!167 = !{!157, !162, !163}
!168 = !{i64 0, i64 3}
!169 = !{!160, !162, !163}
!170 = !{!171}
!171 = distinct !{!171, !172, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!172 = distinct !{!172, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!173 = !{!174}
!174 = distinct !{!174, !172, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!175 = !{!174, !160}
!176 = !{!171, !177, !157, !162, !163}
!177 = distinct !{!177, !172, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4parkNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!178 = !{!171, !157}
!179 = !{!180, !174, !160}
!180 = distinct !{!180, !181, !"_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi: %self"}
!181 = distinct !{!181, !"_RNvMs_CsiYG6txRjdvL_9unir_edgeINtB4_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE4flagCsdMVUwQQj4R6_9unir_cabi"}
!182 = !{!174, !177, !157, !160, !162, !163}
!183 = !{!184}
!184 = distinct !{!184, !185, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_1"}
!185 = distinct !{!185, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!186 = !{!187}
!187 = distinct !{!187, !188, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!188 = distinct !{!188, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!189 = !{!190}
!190 = distinct !{!190, !191, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!191 = distinct !{!191, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!192 = !{!193}
!193 = distinct !{!193, !194, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi: %self"}
!194 = distinct !{!194, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi"}
!195 = !{!196}
!196 = distinct !{!196, !197, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi: %self"}
!197 = distinct !{!197, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi"}
!198 = !{!196, !193, !190, !187, !184}
!199 = !{!200}
!200 = distinct !{!200, !201, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!201 = distinct !{!201, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!202 = !{!203}
!203 = distinct !{!203, !201, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!204 = !{!200, !203, !205, !206}
!205 = distinct !{!205, !201, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!206 = distinct !{!206, !201, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE8try_readNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %buf.0"}
!207 = !{!208}
!208 = distinct !{!208, !209, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4peekNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!209 = distinct !{!209, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4peekNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!210 = !{!211}
!211 = distinct !{!211, !209, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4peekNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!212 = !{!211, !203}
!213 = !{!208, !214, !200, !205, !206}
!214 = distinct !{!214, !209, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4peekNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!215 = !{!211, !214, !200, !203, !205, !206}
!216 = !{!208, !211, !214, !200, !203, !205, !206}
!217 = !{!218}
!218 = distinct !{!218, !219, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!219 = distinct !{!219, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!220 = !{!221, !223, !224, !225, !208, !214, !200, !206}
!221 = distinct !{!221, !222, !"_RNCINvMs1_CsiYG6txRjdvL_9unir_edgeINtB8_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBN_8TemenVatE0CsdMVUwQQj4R6_9unir_cabi: %_0"}
!222 = distinct !{!222, !"_RNCINvMs1_CsiYG6txRjdvL_9unir_edgeINtB8_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBN_8TemenVatE0CsdMVUwQQj4R6_9unir_cabi"}
!223 = distinct !{!223, !222, !"_RNCINvMs1_CsiYG6txRjdvL_9unir_edgeINtB8_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBN_8TemenVatE0CsdMVUwQQj4R6_9unir_cabi: %_1"}
!224 = distinct !{!224, !219, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!225 = distinct !{!225, !219, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE4pollNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!226 = !{!221, !223, !224, !218, !225, !208, !211, !214, !200, !203, !205, !206}
!227 = !{i8 0, i8 7}
!228 = !{!218, !211, !203}
!229 = !{!224, !225, !208, !214, !200, !205, !206}
!230 = !{!208, !200, !206}
!231 = !{i8 0, i8 10}
!232 = !{!224, !218, !225, !208, !211, !214, !200, !203, !205, !206}
!233 = !{!200, !206}
!234 = !{!235, !211, !203}
!235 = distinct !{!235, !236, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!236 = distinct !{!236, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!237 = !{!238, !239, !208, !214, !200, !205, !206}
!238 = distinct !{!238, !236, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!239 = distinct !{!239, !236, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!240 = !{!238, !239, !208, !200, !206}
!241 = !{!203, !205, !206}
!242 = !{!200, !205, !206}
!243 = !{!244}
!244 = distinct !{!244, !245, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!245 = distinct !{!245, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!246 = !{!244, !203}
!247 = !{!248, !249, !200, !205, !206}
!248 = distinct !{!248, !245, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!249 = distinct !{!249, !245, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7advanceNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!250 = !{!248, !249, !200}
!251 = !{!248, !244, !249, !200, !203, !205, !206}
!252 = !{!253, !255, !248, !249, !200}
!253 = distinct !{!253, !254, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!254 = distinct !{!254, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!255 = distinct !{!255, !254, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!256 = !{!257, !244, !203}
!257 = distinct !{!257, !254, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE7publishNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!258 = !{!253, !255, !248, !249, !200, !205, !206}
!259 = !{!248, !200}
!260 = !{!244, !249, !200, !203, !205, !206}
!261 = !{!262}
!262 = distinct !{!262, !263, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!263 = distinct !{!263, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!264 = !{!265, !266}
!265 = distinct !{!265, !263, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!266 = distinct !{!266, !263, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!267 = !{!268}
!268 = distinct !{!268, !269, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_1"}
!269 = distinct !{!269, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!270 = !{!271}
!271 = distinct !{!271, !272, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!272 = distinct !{!272, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!273 = !{!274}
!274 = distinct !{!274, !275, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!275 = distinct !{!275, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!276 = !{!277}
!277 = distinct !{!277, !278, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi: %self"}
!278 = distinct !{!278, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi"}
!279 = !{!280}
!280 = distinct !{!280, !281, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi: %self"}
!281 = distinct !{!281, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi"}
!282 = !{!280, !277, !274, !271, !268}
!283 = !{!284}
!284 = distinct !{!284, !285, !"_RNCNvCsdMVUwQQj4R6_9unir_cabi19unir_consumer_sever0B3_: %_1"}
!285 = distinct !{!285, !"_RNCNvCsdMVUwQQj4R6_9unir_cabi19unir_consumer_sever0B3_"}
!286 = !{!287}
!287 = distinct !{!287, !288, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!288 = distinct !{!288, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!289 = !{!287, !284}
!290 = !{!291, !292}
!291 = distinct !{!291, !288, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!292 = distinct !{!292, !288, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!293 = !{!291}
!294 = !{!291, !287, !292, !284}
!295 = !{!296}
...
!298 = !{!299}
!299 = distinct !{!299, !300, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!300 = distinct !{!300, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!301 = !{!302}
!302 = distinct !{!302, !303, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!303 = distinct !{!303, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!304 = !{!305}
!305 = distinct !{!305, !306, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi: %self"}
!306 = distinct !{!306, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi"}
!307 = !{!308}
...
!311 = !{!312}
!312 = distinct !{!312, !313, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!313 = distinct !{!313, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!314 = !{!315, !316}
!315 = distinct !{!315, !313, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!316 = distinct !{!316, !313, !"_RINvMs1_CsiYG6txRjdvL_9unir_edgeINtB6_8ConsumerNtCsIEB7taFyf8_10unir_temen11TemenRegionE16set_credit_limitNtBL_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!317 = !{!318}
!318 = distinct !{!318, !319, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_1"}
!319 = distinct !{!319, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!320 = !{!321}
!321 = distinct !{!321, !322, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!322 = distinct !{!322, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!323 = !{!324}
!324 = distinct !{!324, !325, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!325 = distinct !{!325, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!326 = !{!327}
!327 = distinct !{!327, !328, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi: %self"}
!328 = distinct !{!328, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi"}
!329 = !{!330}
!330 = distinct !{!330, !331, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi: %self"}
!331 = distinct !{!331, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi"}
!332 = !{!330, !327, !324, !321, !318}
!333 = !{!334}
!334 = distinct !{!334, !335, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %self"}
!335 = distinct !{!335, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!336 = !{!337, !338}
!337 = distinct !{!337, !335, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_0"}
!338 = distinct !{!338, !335, !"_RINvMs_CsiYG6txRjdvL_9unir_edgeINtB5_3EndNtCsIEB7taFyf8_10unir_temen11TemenRegionE3actNtBF_8TemenVatECsdMVUwQQj4R6_9unir_cabi: %s"}
!339 = !{!337}
!340 = !{!337, !334, !338}
!341 = !{!342}
!342 = distinct !{!342, !343, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi: %_1"}
!343 = distinct !{!343, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeNtCsIEB7taFyf8_10unir_temen8TemenVatECsdMVUwQQj4R6_9unir_cabi"}
!344 = !{!345}
!345 = distinct !{!345, !346, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!346 = distinct !{!346, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc3vec3VecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!347 = !{!348}
!348 = distinct !{!348, !349, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi: %_1"}
!349 = distinct !{!349, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc7raw_vec6RawVecINtNtB4_6option6OptionxEEECsdMVUwQQj4R6_9unir_cabi"}
!350 = !{!351}
!351 = distinct !{!351, !352, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi: %self"}
!352 = distinct !{!352, !"_RNvXs1_NtCsksNX8Mxey3D_5alloc7raw_vecINtB5_6RawVecINtNtCscliFh4jUES5_4core6option6OptionxEENtNtNtBR_3ops4drop4Drop4dropCsdMVUwQQj4R6_9unir_cabi"}
!353 = !{!354}
!354 = distinct !{!354, !355, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi: %self"}
!355 = distinct !{!355, !"_RNvMs2_NtCsksNX8Mxey3D_5alloc7raw_vecNtB5_11RawVecInner10deallocateCsdMVUwQQj4R6_9unir_cabi"}
!356 = !{!354, !351, !348, !345, !342}
!357 = !{!358, !360}
!358 = distinct !{!358, !359, !"_RNvXs8_NtCsksNX8Mxey3D_5alloc5boxedINtB5_3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirProducerENtNtNtCscliFh4jUES5_4core3ops4drop4Drop4dropBJ_: %self"}
!359 = distinct !{!359, !"_RNvXs8_NtCsksNX8Mxey3D_5alloc5boxedINtB5_3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirProducerENtNtNtCscliFh4jUES5_4core3ops4drop4Drop4dropBJ_"}
!360 = distinct !{!360, !361, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc5boxed3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirProducerEEB1h_: %_1"}
!361 = distinct !{!361, !"_RINvNtCscliFh4jUES5_4core3ptr13drop_in_placeINtNtCsksNX8Mxey3D_5alloc5boxed3BoxNtCsdMVUwQQj4R6_9unir_cabi12UnirProducerEEB1h_"}
!362 = !{!363, !365}
...
!604 = distinct !{!604, !605, !"_RNCINvNvNtNtNtNtCscliFh4jUES5_4core4iter6traits8iterator8Iterator8find_map5checkllNCNvCsIEB7taFyf8_10unir_temen11cap_of_type0E0B1m_: %_1"}
!605 = distinct !{!605, !"_RNCINvNvNtNtNtNtCscliFh4jUES5_4core4iter6traits8iterator8Iterator8find_map5checkllNCNvCsIEB7taFyf8_10unir_temen11cap_of_type0E0B1m_"}
