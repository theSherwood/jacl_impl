...
static int test_opcode_enum(void) {
  ...
  ASSERT_INT_EQ(OP_ATOM,            68);
  ASSERT_INT_EQ(OP_DEREF,           69);
  ASSERT_INT_EQ(OP_RESET,           70);
  ASSERT_INT_EQ(OP_SWAP,            71);
  ASSERT_INT_EQ(OP_IS_BOX,          72);
  ASSERT_INT_EQ(OP_IS_ATOM,         73);
  ASSERT_INT_EQ(OP_IS_FUTURE,       74);
  /* M13 CPS and concurrency opcodes */
  ASSERT_INT_EQ(OP_AWAIT,           75);
  ASSERT_INT_EQ(OP_SPAWN,           76);
  ASSERT_INT_EQ(OP_RESOLVE_FUTURE,  77);
  ASSERT_INT_EQ(OP_PARALLEL,        78);
  ASSERT_INT_EQ(OP_RACE,            79);
  ASSERT_INT_EQ(OP_COMPLETE_PARALLEL, 80);
  ASSERT_INT_EQ(OP_COMPLETE_RACE,    81);
  /* M11 typed opcodes */
  ASSERT_INT_EQ(OP_ADD_I64,         82);
  ASSERT_INT_EQ(OP_SUB_I64,         83);
  ASSERT_INT_EQ(OP_MUL_I64,         84);
  ASSERT_INT_EQ(OP_DIV_I64,         85);
  ASSERT_INT_EQ(OP_MOD_I64,         86);
  ASSERT_INT_EQ(OP_NEG_I64,         87);
  ASSERT_INT_EQ(OP_LT_I64,          88);
  ASSERT_INT_EQ(OP_GT_I64,          89);
  ASSERT_INT_EQ(OP_LE_I64,          90);
  ASSERT_INT_EQ(OP_GE_I64,          91);
  ASSERT_INT_EQ(OP_EQ_I64,          92);
  ASSERT_INT_EQ(OP_DIV_U64,         93);
  ASSERT_INT_EQ(OP_MOD_U64,         94);
  ASSERT_INT_EQ(OP_LT_U64,          95);
  ASSERT_INT_EQ(OP_GT_U64,          96);
  ASSERT_INT_EQ(OP_LE_U64,          97);
  ASSERT_INT_EQ(OP_GE_U64,          98);
  ASSERT_INT_EQ(OP_ADD_F64,         99);
  ASSERT_INT_EQ(OP_SUB_F64,        100);
  ASSERT_INT_EQ(OP_MUL_F64,        101);
  ASSERT_INT_EQ(OP_DIV_F64,        102);
  ASSERT_INT_EQ(OP_MOD_F64,        103);
  ASSERT_INT_EQ(OP_NEG_F64,        104);
  ASSERT_INT_EQ(OP_LT_F64,         105);
  ASSERT_INT_EQ(OP_GT_F64,         106);
  ASSERT_INT_EQ(OP_LE_F64,         107);
  ASSERT_INT_EQ(OP_GE_F64,         108);
  ASSERT_INT_EQ(OP_EQ_F64,         109);
  ASSERT_INT_EQ(OP_TO_I32,         110);
  ASSERT_INT_EQ(OP_TO_I64,         111);
  ASSERT_INT_EQ(OP_TO_U32,         112);
  ASSERT_INT_EQ(OP_TO_U64,         113);
  ASSERT_INT_EQ(OP_TO_F32,         114);
  ASSERT_INT_EQ(OP_TO_F64,         115);
  ASSERT_INT_EQ(OP_TO_DYN,         116);
  ASSERT_INT_EQ(OP_CONST_I64,      117);
  ASSERT_INT_EQ(OP_CONST_U64,      118);
  ASSERT_INT_EQ(OP_CONST_F64,      119);
  ASSERT_INT_EQ(OP_STRUCT_NEW,     120);
  ASSERT_INT_EQ(OP_STRUCT_GET,     121);
  ASSERT_INT_EQ(OP_STRUCT_SET,     122);
  ASSERT_INT_EQ(OP_STRUCT_GET_DYN, 123);
  ASSERT_INT_EQ(OP_STRUCT_SET_DYN, 124);
  ASSERT_INT_EQ(OP_STRUCT_NEW_INLINE, 125);
  ASSERT_INT_EQ(OP_STRUCT_GET_INLINE, 126);
  ASSERT_INT_EQ(OP_STRUCT_SET_INLINE, 127);
  ASSERT_INT_EQ(OP_STRUCT_MATERIALIZE, 128);
  ASSERT_INT_EQ(OP_STRUCT_COPY,       129);
  ASSERT_INT_EQ(OP_STRUCT_STORE_INLINE, 130);
  ASSERT_INT_EQ(OP_STRUCT_GET_UPVALUE, 131);
  ASSERT_INT_EQ(OP_STRUCT_SET_UPVALUE, 132);
  ASSERT_INT_EQ(OP_STRUCT_MATERIALIZE_UPVALUE, 133);
  ASSERT_INT_EQ(OP_CLOSE_LOOP,        134);
  ASSERT_INT_EQ(OP_DESTRUCTURE_VEC,  135);
  ASSERT_INT_EQ(OP_DESTRUCTURE_NAMED, 136);
  ASSERT_INT_EQ(OP_DESTRUCTURE_VEC_REST, 137);
  ASSERT_INT_EQ(OP_DESTRUCTURE_NAMED_REST, 138);
  ASSERT_INT_EQ(OP_SPREAD,           139);
  ASSERT_INT_EQ(OP_CALL_SPREAD,      140);
  ASSERT_INT_EQ(OP_FOLD_SPREAD,      141);
  ASSERT_INT_EQ(OP_COLLECT_VARIADIC, 142);
  ASSERT_INT_EQ(OP_YIELD,            143);
  ASSERT_INT_EQ(OP_STREAM_NEXT,      144);
  ASSERT_INT_EQ(OP_COLLECT,          145);
  ASSERT_INT_EQ(OP_IS_STREAM_EXHAUSTED, 146);
  ASSERT_INT_EQ(OP_COUNT,            147);
  ASSERT_INT_EQ(OP_TAKE,             148);
  ASSERT_INT_EQ(OP_FIRST,            149);
  ASSERT_INT_EQ(OP_LINES,            150);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD,  151);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD,  152);
  ASSERT_INT_EQ(OP_GET_RESUME_POINT, 153);
  ASSERT_INT_EQ(OP_SET_RESUME_POINT, 154);
  ASSERT_INT_EQ(OP_YIELD_SM,        155);
  ASSERT_INT_EQ(OP_AWAIT_SM,        156);
  ASSERT_INT_EQ(OP_CALL_SUSPEND,   157);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD_CELL, 158);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD_CELL, 159);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD_WIDE, 160);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD_WIDE, 161);
  ASSERT_INT_EQ(OP_SYNTAX_SPLICE,   162);
  ASSERT_INT_EQ(OP_SYNTAX_OP,       163);
  ASSERT_INT_EQ(OP_INTERPRET,       164);
  ASSERT_INT_EQ(OP_INTERPRET_PRELUDE, 165);
  ASSERT_INT_EQ(OP_EXEC,             166);
  ASSERT_INT_EQ(OP_AWAIT_JOB,        167);
  ASSERT_INT_EQ(OP_SIGNAL,           168);
  ASSERT_INT_EQ(OP_HALT,             169);
  TEST_PASS();
}
