...
static int test_opcode_enum(void) {
  ...
  ASSERT_INT_EQ(OP_CALL_SUSPEND,   169);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD_CELL, 170);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD_CELL, 171);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD_WIDE, 172);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD_WIDE, 173);
  ASSERT_INT_EQ(OP_SYNTAX_SPLICE,   174);
  ASSERT_INT_EQ(OP_SYNTAX_OP,       175);
  ASSERT_INT_EQ(OP_INTERPRET,       176);
  ASSERT_INT_EQ(OP_INTERPRET_PRELUDE, 177);
  ASSERT_INT_EQ(OP_EXEC,             178);
  ASSERT_INT_EQ(OP_AWAIT_JOB,        179);
  ASSERT_INT_EQ(OP_SIGNAL,           180);
  ASSERT_INT_EQ(OP_HALT,             181);
  TEST_PASS();
}
