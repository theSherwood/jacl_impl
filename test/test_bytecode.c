...
static int test_opcode_enum(void) {
  ...
  ASSERT_INT_EQ(OP_STRUCT_NEW,     123);
  ASSERT_INT_EQ(OP_STRUCT_GET,     124);
  ASSERT_INT_EQ(OP_STRUCT_SET,     125);
  ASSERT_INT_EQ(OP_STRUCT_GET_DYN, 126);
  ASSERT_INT_EQ(OP_STRUCT_SET_DYN, 127);
