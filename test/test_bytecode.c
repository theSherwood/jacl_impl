...
static int test_opcode_enum(void) {
  ...
  ASSERT_INT_EQ(OP_STRUCT_NEW_INLINE, 128);
  ASSERT_INT_EQ(OP_STRUCT_GET_INLINE, 129);
  ASSERT_INT_EQ(OP_STRUCT_SET_INLINE, 130);
  ASSERT_INT_EQ(OP_STRUCT_MATERIALIZE, 131);
  ASSERT_INT_EQ(OP_STRUCT_COPY,       132);
  ASSERT_INT_EQ(OP_STRUCT_STORE_INLINE, 133);
  ASSERT_INT_EQ(OP_STRUCT_GET_UPVALUE, 134);
  ASSERT_INT_EQ(OP_STRUCT_SET_UPVALUE, 135);
  ASSERT_INT_EQ(OP_STRUCT_MATERIALIZE_UPVALUE, 136);
