...
static int test_opcode_enum(void) {
  ...
  ASSERT_INT_EQ(OP_IS_ATOM,         74);
  ASSERT_INT_EQ(OP_IS_FUTURE,       75);
  /* M13 CPS and concurrency opcodes */
  ASSERT_INT_EQ(OP_AWAIT,           76);
  ASSERT_INT_EQ(OP_SPAWN,           77);
  ASSERT_INT_EQ(OP_RESOLVE_FUTURE,  78);
  ASSERT_INT_EQ(OP_PARALLEL,        79);
  ASSERT_INT_EQ(OP_RACE,            80);
  ASSERT_INT_EQ(OP_COMPLETE_PARALLEL, 81);
  ASSERT_INT_EQ(OP_COMPLETE_RACE,    82);
  /* M11 typed opcodes */
  ASSERT_INT_EQ(OP_ADD_I64,         83);
  ASSERT_INT_EQ(OP_SUB_I64,         84);
  ASSERT_INT_EQ(OP_MUL_I64,         85);
  ASSERT_INT_EQ(OP_DIV_I64,         86);
  ASSERT_INT_EQ(OP_MOD_I64,         87);
  ASSERT_INT_EQ(OP_NEG_I64,         88);
  ASSERT_INT_EQ(OP_LT_I64,          89);
  ASSERT_INT_EQ(OP_GT_I64,          90);
  ASSERT_INT_EQ(OP_LE_I64,          91);
  ASSERT_INT_EQ(OP_GE_I64,          92);
  ASSERT_INT_EQ(OP_EQ_I64,          93);
  ASSERT_INT_EQ(OP_DIV_U64,         94);
  ASSERT_INT_EQ(OP_MOD_U64,         95);
  ASSERT_INT_EQ(OP_LT_U64,          96);
  ASSERT_INT_EQ(OP_GT_U64,          97);
  ASSERT_INT_EQ(OP_LE_U64,          98);
  ASSERT_INT_EQ(OP_GE_U64,          99);
  ASSERT_INT_EQ(OP_ADD_F64,        100);
  ASSERT_INT_EQ(OP_SUB_F64,        101);
  ASSERT_INT_EQ(OP_MUL_F64,        102);
  ASSERT_INT_EQ(OP_DIV_F64,        103);
  ASSERT_INT_EQ(OP_MOD_F64,        104);
  ASSERT_INT_EQ(OP_NEG_F64,        105);
  ASSERT_INT_EQ(OP_LT_F64,         106);
  ASSERT_INT_EQ(OP_GT_F64,         107);
  ASSERT_INT_EQ(OP_LE_F64,         108);
  ASSERT_INT_EQ(OP_GE_F64,         109);
  ASSERT_INT_EQ(OP_EQ_F64,         110);
  ASSERT_INT_EQ(OP_TO_I32,         111);
  ASSERT_INT_EQ(OP_TO_I64,         112);
  ASSERT_INT_EQ(OP_TO_U32,         113);
  ASSERT_INT_EQ(OP_TO_U64,         114);
  ASSERT_INT_EQ(OP_TO_F32,         115);
  ASSERT_INT_EQ(OP_TO_F64,         116);
  ASSERT_INT_EQ(OP_TO_DYN,         117);
  ASSERT_INT_EQ(OP_CONST_I64,      118);
  ASSERT_INT_EQ(OP_CONST_U64,      119);
  ASSERT_INT_EQ(OP_CONST_F64,      120);
  ASSERT_INT_EQ(OP_STRUCT_NEW,     121);
  ASSERT_INT_EQ(OP_STRUCT_GET,     122);
  ASSERT_INT_EQ(OP_STRUCT_SET,     123);
  ASSERT_INT_EQ(OP_STRUCT_GET_DYN, 124);
  ASSERT_INT_EQ(OP_STRUCT_SET_DYN, 125);
  ASSERT_INT_EQ(OP_STRUCT_NEW_INLINE, 126);
  ASSERT_INT_EQ(OP_STRUCT_GET_INLINE, 127);
  ASSERT_INT_EQ(OP_STRUCT_SET_INLINE, 128);
  ASSERT_INT_EQ(OP_STRUCT_MATERIALIZE, 129);
  ASSERT_INT_EQ(OP_STRUCT_COPY,       130);
  ASSERT_INT_EQ(OP_STRUCT_STORE_INLINE, 131);
  ASSERT_INT_EQ(OP_STRUCT_GET_UPVALUE, 132);
  ASSERT_INT_EQ(OP_STRUCT_SET_UPVALUE, 133);
  ASSERT_INT_EQ(OP_STRUCT_MATERIALIZE_UPVALUE, 134);
  ASSERT_INT_EQ(OP_CLOSE_LOOP,        135);
  ASSERT_INT_EQ(OP_DESTRUCTURE_VEC,  136);
  ASSERT_INT_EQ(OP_DESTRUCTURE_NAMED, 137);
  ASSERT_INT_EQ(OP_DESTRUCTURE_VEC_REST, 138);
  ASSERT_INT_EQ(OP_DESTRUCTURE_NAMED_REST, 139);
  ASSERT_INT_EQ(OP_SPREAD,           140);
  ASSERT_INT_EQ(OP_CALL_SPREAD,      141);
  ASSERT_INT_EQ(OP_FOLD_SPREAD,      142);
  ASSERT_INT_EQ(OP_COLLECT_VARIADIC, 143);
  ASSERT_INT_EQ(OP_YIELD,            144);
  ASSERT_INT_EQ(OP_STREAM_NEXT,      145);
  ASSERT_INT_EQ(OP_COLLECT,          146);
  ASSERT_INT_EQ(OP_IS_STREAM_EXHAUSTED, 147);
  ASSERT_INT_EQ(OP_COUNT,            148);
  ASSERT_INT_EQ(OP_TAKE,             149);
  ASSERT_INT_EQ(OP_FIRST,            150);
  ASSERT_INT_EQ(OP_LINES,            151);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD,  152);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD,  153);
  ASSERT_INT_EQ(OP_GET_RESUME_POINT, 154);
  ASSERT_INT_EQ(OP_SET_RESUME_POINT, 155);
  ASSERT_INT_EQ(OP_YIELD_SM,        156);
  ASSERT_INT_EQ(OP_AWAIT_SM,        157);
  ASSERT_INT_EQ(OP_CALL_SUSPEND,   158);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD_CELL, 159);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD_CELL, 160);
  ASSERT_INT_EQ(OP_GET_STATE_FIELD_WIDE, 161);
  ASSERT_INT_EQ(OP_SET_STATE_FIELD_WIDE, 162);
  ASSERT_INT_EQ(OP_SYNTAX_SPLICE,   163);
  ASSERT_INT_EQ(OP_SYNTAX_OP,       164);
  ASSERT_INT_EQ(OP_INTERPRET,       165);
  ASSERT_INT_EQ(OP_INTERPRET_PRELUDE, 166);
  ASSERT_INT_EQ(OP_EXEC,             167);
  ASSERT_INT_EQ(OP_AWAIT_JOB,        168);
  ASSERT_INT_EQ(OP_SIGNAL,           169);
  ASSERT_INT_EQ(OP_HALT,             170);
  TEST_PASS();
}
